...
The cvp/users_and_roles/vars/users_and_roles_workflow_inputs.yml file stores the user and role details you want to configure.
...
```bash
    (pyats)  dnac_ansible_workflows % ./tools/schemavalidation.sh -s cvp/users_and_roles/schema/users_and_roles_workflow_schema.yml -v cvp/users_and_roles/vars/users_and_roles_workflow_inputs.yml                             
    cvp/users_and_roles/schema/users_and_roles_workflow_schema.yml
    cvp/users_and_roles/vars/users_and_roles_workflow_inputs.yml
    yamale   -s cvp/users_and_roles/schema/users_and_roles_workflow_schema.yml  cvp/users_and_roles/vars/users_and_roles_workflow_inputs.yml
    Validating /Users/pawansi/dnac_ansible_cvp/cvp/users_and_roles/vars/users_and_roles_workflow_inputs.yml...
    Validation success! 👍
```
...
```bash
    ansible-playbook -i host_inventory_dnac1/hosts.yml cvp/users_and_roles/playbook/users_and_roles_workflow_playbook.yml --e VARS_FILE_PATH=../vars/users_and_roles_workflow_inputs.yml -vvvv
```
   **Example:**
```yaml
  role_details:
...
```bash
    dnac_ansible_workflows % ansible-playbook -i host_inventory_dnac1/hosts.yml cvp/users_and_roles/playbook/users_and_roles_workflow_playbook.yml --ask-vault-pass --e VARS_FILE_PATH=../jinja_template/template_users_and_roles_workflow_inputs.j2 -vvvv
```
...
```bash
    dnac_ansible_workflows % ansible-playbook -i host_inventory_dnac1/hosts.yml cvp/users_and_roles/playbook/delete_users_and_roles_workflow_playbook.yml  --ask-vault-pass --e VARS_FILE_PATH=../jinja_template/template_users_and_roles_workflow_inputs.j2 -vvvv
```
...
ansible-playbook -i ./inventory/demo_lab/hosts.yaml ./cvp/users_and_roles/playbook/users_and_roles_workflow_playbook.yml -vvvv
```
...
2. Copy the sample workflow data from `cvp/users_and_roles/vars/users_and_roles_workflow_inputs.yml` into that inventory vars file.
3. Keep the same top-level variable name in inventory: `roles_users_details`.
4. Run the playbook without `VARS_FILE_PATH`:

```bash
ansible-playbook -i <inventory-file> cvp/users_and_roles/playbook/users_and_roles_workflow_playbook.yml -vvvv
```
...
- Fully resolved from the repo root: `${PWD}/cvp/users_and_roles/vars/users_and_roles_workflow_inputs.yml`
