...
## Running playbook
```bash
ansible-playbook -i host_inventory_dnac1/hosts.yml  cvp/sda_virtual_networks_l2l3_gateways/playbook/sda_virtual_networks_l2_l3_gateways_playbook.yml --e VARS_FILE_PATH=../vars/sda_virtual_networks_l2_l3_gateways_input.yml -vvvv
```
...
### 5. How to Run
  ...
  **For the Deleted Method**, change the destination playbook to: `./cvp/sda_virtual_networks_l2l3_gateways/playbook/delete_sda_virtual_networks_l2_l3_gateways_playbook.yml`

  **Validate the playbooks with schema:** Used to verify if the input is valid for execution in the module.
  ```bash
  (pyats-ansible-phamdat) bash-4.4$ yamale -s cvp/sda_virtual_networks_l2l3_gateways/schema/sda_virtual_networks_l2_l3_gateways_schema.yml cvp/sda_virtual_networks_l2l3_gateways/vars/sda_virtual_networks_l2_l3_gateways_input.yml
  Validating cvp/sda_virtual_networks_l2l3_gateways/vars/sda_virtual_networks_l2_l3_gateways_input.yml...
  Validation success! 👍
  ```
...
### 2. Create a Scale layer3 and Scale layer2
  #### a. JINJA Template
  cvp/sda_virtual_networks_l2l3_gateways/jinja_template/sda_vn_l2_l3_gateways_jinja_template.j2 template can be used to customize the template and generate bulk layer2, layer3.
  ```jinja
    # -------------------- Valid VLAN range -------------------- #
  ...
  **cmd to run:**
  ansible-playbook -i ./inventory/demo_lab/inventory_demo_lab.yml ./cvp/sda_virtual_networks_l2l3_gateways/playbook/sda_virtual_networks_l2_l3_gateways_playbook.yml --extra-vars VARS_FILE_PATH=../vars/sda_virtual_networks_l2_l3_gateways_jinja_input.yml


  ```bash
    (pyats-ansible-phamdat) bash-4.4$ ansible-playbook -i ./inventory/demo_lab/inventory_demo_lab.yml ./cvp/sda_virtual_networks_l2l3_gateways/playbook/sda_virtual_networks_l2_l3_gateways_playbook.yml --extra-vars VARS_FILE_PATH=../vars/sda_virtual_networks_l2_l3_gateways_jinja_input.yml
...
### 3. Delete a Scale layer3 and Scale layer2
  ...
  ```bash
    (pyats-ansible-phamdat) bash-4.4$ ansible-playbook -i ./inventory/demo_lab/inventory_demo_lab.yml ./cvp/sda_virtual_networks_l2l3_gateways/playbook/delete_sda_virtual_networks_l2_l3_gateways_playbook.yml --extra-vars VARS_FILE_PATH=../vars/s
...
ansible-playbook -i ./inventory/demo_lab/hosts.yaml ./cvp/sda_virtual_networks_l2l3_gateways/playbook/sda_virtual_networks_l2_l3_gateways_playbook.yml -vvvv
```
...
2. Copy the sample workflow data from `cvp/sda_virtual_networks_l2l3_gateways/vars/sda_virtual_networks_l2_l3_gateways_input.yml` into that inventory vars file.
3. Keep the same top-level variable name in inventory: `sda_fabric_virtual_networks_details`.
4. Run the playbook without `VARS_FILE_PATH`:

```bash
ansible-playbook -i <inventory-file> cvp/sda_virtual_networks_l2l3_gateways/playbook/sda_virtual_networks_l2_l3_gateways_playbook.yml -vvvv
```
...
- Fully resolved from the repo root: `${PWD}/cvp/sda_virtual_networks_l2l3_gateways/vars/sda_virtual_networks_l2_l3_gateways_input.yml`
