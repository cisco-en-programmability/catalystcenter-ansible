...
Install Ansible if you haven't already Ensure you have network connectivity to your Catalyst Center instance. Checkout the project and playbooks: git@github.com:cisco-en-programmability/catalystcenter-ansible.git
2. ## Compatibility
...
- User inputs are stored in **cvp/network_compliance/vars/network_compliance_workflow_inputs.yml**.

### Validate user input before running through Ansible

command to validate:
```bash
./tools/schemavalidation.sh -s cvp/network_compliance/schema/network_compliance_workflow_schema.yml -v cvp/network_compliance/vars/network_compliance_workflow_input.yml 
```
result:
```bash
cvp/network_compliance/schema/network_compliance_workflow_schema.yml
cvp/network_compliance/vars/network_compliance_workflow_input.yml
yamale   -s cvp/network_compliance/schema/network_compliance_workflow_schema.yml  cvp/network_compliance/vars/network_compliance_workflow_input.yml
Validating /Users/pawansi/dnac_ansible_cvp/cvp/network_compliance/vars/network_compliance_workflow_input.yml...
Validation success! 👍
```
...
```bash
ansible-playbook -i host_inventory_dnac1/hosts.yml cvp/network_compliance/playbook/network_compliance_workflow_playbook.yml --e VARS_FILE_PATH=../vars/network_compliance_workflow_input.yml -vvvv
```
...
```bash
(pyats) pawansi@PAWANSI-M-81A3 dnac_ansible_workflows % ansible-playbook -i host_inventory_dnac1/hosts.yml cvp/network_compliance/playbook/network_compliance_workflow_playbook.yml --e VARS_FILE_PATH=../vars/network_compliance_workflow_input.yml -vvvv
...
host_list declined parsing /Users/pawansi/dnac_ansible_cvp/host_inventory_dnac1/hosts.yml as it did not pass its verify_file() method
script declined parsing /Users/pawansi/dnac_ansible_cvp/host_inventory_dnac1/hosts.yml as it did not pass its verify_file() method
Parsed /Users/pawansi/dnac_ansible_cvp/host_inventory_dnac1/hosts.yml inventory source with yaml plugin
Loading collection cisco.catalystcenter from /Users/pawansi/.ansible/collections/ansible_collections/cisco/catalystcenter
...
Positional arguments: cvp/network_compliance/playbook/network_compliance_workflow_playbook.yml
verbosity: 4
connection: smart
timeout: 10
become_method: sudo
tags: ('all',)
inventory: ('/Users/pawansi/dnac_ansible_cvp/host_inventory_dnac1/hosts.yml',)
extra_vars: ('VARS_FILE_PATH=../vars/network_compliance_workflow_input.yml',)
forks: 5
1 plays in cvp/network_compliance/playbook/network_compliance_workflow_playbook.yml
...
task path: /Users/pawansi/dnac_ansible_cvp/cvp/network_compliance/playbook/network_compliance_workflow_playbook.yml:26
...
TASK [Network Compliance devices on Cisco Catalyst Center] **********************************************************************************************************************************************************************************************
task path: /Users/pawansi/dnac_ansible_cvp/cvp/network_compliance/playbook/network_compliance_workflow_playbook.yml:29
...
task path: /Users/pawansi/dnac_ansible_cvp/cvp/network_compliance/playbook/network_compliance_workflow_playbook.yml:35
ok: [catalyst_center220] => {
    "msg": {
        "ansible_facts": {
            "discovered_interpreter_python": "/Users/pawansi/workspace/dnac_auto/pyats/bin/python3.11"
...
task path: /Users/pawansi/dnac_ansible_cvp/cvp/network_compliance/playbook/network_compliance_workflow_playbook.yml:38
ok: [catalyst_center220] => {
    "ansible_facts": {
...
task path: /Users/pawansi/dnac_ansible_cvp/cvp/network_compliance/playbook/network_compliance_workflow_playbook.yml:41
ok: [catalyst_center220] => {
...
task path: /Users/pawansi/dnac_ansible_cvp/cvp/network_compliance/playbook/network_compliance_workflow_playbook.yml:45
Read vars_file '{{ VARS_FILE_PATH }}'
...
ansible-playbook -i ./inventory/demo_lab/hosts.yaml ./cvp/network_compliance/playbook/network_compliance_workflow_playbook.yml -vvvv
```
...
2. Copy the sample workflow data from `cvp/network_compliance/vars/network_compliance_workflow_input.yml` into that inventory vars file.
3. Keep the same top-level variable name in inventory: `network_compliance_details`.
4. Run the playbook without `VARS_FILE_PATH`:

```bash
ansible-playbook -i <inventory-file> cvp/network_compliance/playbook/network_compliance_workflow_playbook.yml -vvvv
```
...
- Fully resolved from the repo root: `${PWD}/cvp/network_compliance/vars/network_compliance_workflow_input.yml`
