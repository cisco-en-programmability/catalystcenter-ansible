...
This workflow playbook automates the management of assurance issues within Cisco Catalyst Center (formerly Cisco Catalyst Center).      
...
ansible-playbook -i ./inventory/demo_lab/hosts.yaml ./cvp/assurance_issues_management/playbook/assurance_issues_management_playbook.yml -vvvv
```
...
./tools/schemavalidation.sh -s ./cvp/assurance_issues_management/schema/assurance_issues_management_schema.yml -v ./cvp/assurance_issues_management/vars/assurance_issues_management_inputs.yml
```
...
```bash
ansible-playbook -i ./inventory/demo_lab/hosts.yaml ./cvp/assurance_issues_management/playbook/assurance_issues_management_playbook.yml --extra-vars VARS_FILE_PATH=../vars/assurance_issues_management_inputs.yml -vvvv  
```
...
## Reference
Refer to the workflow's schema file (cvp/assurance_issues_management/schema/assurance_issues_management_schema.yml) for the definitive list of input parameters and their descriptions.
...
2. Copy the sample workflow data from `cvp/assurance_issues_management/vars/assurance_issues_management_inputs.yml` into that inventory vars file.
3. Keep the same top-level variable name in inventory: `assurance_issues_settings`.
4. Run the playbook without `VARS_FILE_PATH`:

```bash
ansible-playbook -i <inventory-file> cvp/assurance_issues_management/playbook/assurance_issues_management_playbook.yml -vvvv
```
...
- Fully resolved from the repo root: `${PWD}/cvp/assurance_issues_management/vars/assurance_issues_management_inputs.yml`
