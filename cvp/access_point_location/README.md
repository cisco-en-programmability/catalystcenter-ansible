...
ansible-playbook -i ./inventory/demo_lab/hosts.yaml ./cvp/access_point_location/playbook/access_point_location_playbook.yml -vvvv
```
...
```bash
# Validate
./tools/validate.sh -s ./cvp/access_point_location/schema/access_point_location_schema.yml -d ./cvp/access_point_location/vars/access_point_location_inputs.yml
```

Return result validate:

```bash
./cvp/access_point_location/schema/access_point_location_schema.yml
./cvp/access_point_location/vars/access_point_location_inputs.yml
yamale   -s ./cvp/access_point_location/schema/access_point_location_schema.yml  ./cvp/access_point_location/vars/access_point_location_inputs.yml
Validating ./cvp/access_point_location/vars/access_point_location_inputs.yml...
Validation success! 👍
```
...
ansible-playbook -i inventory/demo_lab/hosts.yaml \
  cvp/access_point_location/playbook/access_point_location_playbook.yml \
...
```bash
# Validate
./tools/validate.sh -s ./cvp/access_point_location/schema/delete_access_point_location_schema.yml -d ./cvp/access_point_location/vars/delete_access_point_location_inputs.yml
```

Return result validate:

```bash
./cvp/access_point_location/schema/delete_access_point_location_schema.yml
./cvp/access_point_location/vars/delete_access_point_location_inputs.yml
yamale   -s ./cvp/access_point_location/schema/delete_access_point_location_schema.yml  ./cvp/access_point_location/vars/delete_access_point_location_inputs.yml
Validating ./cvp/access_point_location/vars/delete_access_point_location_inputs.yml...
Validation success! 👍
```
...
# Execute
ansible-playbook -i inventory/demo_lab/hosts.yaml \
  cvp/access_point_location/playbook/delete_access_point_location_playbook.yml \
...
- [Access Point Location Workflow Manager Module Documentation](https://github.com/cisco-en-programmability/catalystcenter-ansible/blob/main/plugins/modules/accesspoint_location_workflow_manager.py)
...
2. Copy the sample workflow data from `cvp/access_point_location/vars/access_point_location_inputs.yml` into that inventory vars file.
3. Keep the same top-level variable name in inventory: `accesspoint_location_details`.
4. Run the playbook without `VARS_FILE_PATH`:

```bash
ansible-playbook -i <inventory-file> cvp/access_point_location/playbook/access_point_location_playbook.yml -vvvv
```
