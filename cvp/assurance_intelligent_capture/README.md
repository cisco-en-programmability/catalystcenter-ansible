...
ansible-playbook -i ./inventory/demo_lab/hosts.yaml ./cvp/assurance_intelligent_capture/playbook/assurance_intelligent_capture_playbook.yml -vvvv
```
...
```bash
./tools/schemavalidation.sh -s ./cvp/assurance_intelligent_capture/schema/assurance_intelligent_capture_schema.yml -v ./cvp/assurance_intelligent_capture/vars/assurance_intelligent_capture_inputs.yml
```
---
...
1. **Deploy Configuration:**  
   ...
   ```bash
   ansible-playbook -i ./inventory/hosts.yml cvp/assurance_intelligent_capture/playbook/assurance_intelligent_capture_playbook.yml --e VARS_FILE_PATH=../vars/assurance_intelligent_capture_inputs.yml -vvvv
   ```
...
2. Copy the sample workflow data from `cvp/assurance_intelligent_capture/vars/assurance_intelligent_capture_inputs.yml` into that inventory vars file.
3. Keep the same top-level variable name in inventory: `assurance_inteligent_capture_settings`.
4. Run the playbook without `VARS_FILE_PATH`:

```bash
ansible-playbook -i <inventory-file> cvp/assurance_intelligent_capture/playbook/assurance_intelligent_capture_playbook.yml -vvvv
```
...
- Fully resolved from the repo root: `${PWD}/cvp/assurance_intelligent_capture/vars/assurance_intelligent_capture_inputs.yml`
