...
class WirelessSettingsApAuthorizationLists(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params["ap_authorization_list_name"] = self.new_object.get("apAuthorizationListName") or self.new_object.get(
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessSettingsApAuthorizationLists(self._task.args, catalystcenter)
