...
class ConnectionModesettingV1(object):
    ...
    def update_all_params(self):
        new_object_params = {}
        new_object_params['connectionMode'] = self.new_object.get(
            'connectionMode')
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="licenses",
            function="update_c_s_s_m_connection_mode_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = ConnectionModesettingV1(self._task.args, catalystcenter)
