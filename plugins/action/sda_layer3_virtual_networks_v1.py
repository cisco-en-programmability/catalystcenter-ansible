...
class SdaLayer3VirtualNetworksV1(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        if isinstance(self.new_object.get("payload"), list):
            ...
            if "fabricIds" in self.new_object.get("payload")[0]:
                new_object_params['fabric_id'] = self.new_object.get('fabricId') or self.new_object.get(
                    'fabric_id') or self.new_object.get('payload')[0]['fabricIds'][0]
    ...
    def get_object_by_name(self, name, is_absent=False):
        ...
        try:
            items = self.catalystcenter.exec(
                family="sda",
                function="get_layer3_virtual_networks_v1",
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="sda",
            function="add_layer3_virtual_networks_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="update_layer3_virtual_networks_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="delete_layer3_virtual_networks_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaLayer3VirtualNetworksV1(self._task.args, catalystcenter)
