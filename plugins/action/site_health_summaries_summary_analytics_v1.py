...
class SiteHealthSummariesSummaryAnalyticsV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="sites",
            function="query_an_aggregated_summary_of_site_health_data_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SiteHealthSummariesSummaryAnalyticsV1(self._task.args, catalystcenter)
