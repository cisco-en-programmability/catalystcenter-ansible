...
class WirelessSettingsAnchorGroupsIdV1(object):
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.catalystcenter.exec(
                family="wireless",
                function="get_anchor_group_by_id_v1",
                params={"id": id}
            )
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="wireless",
            function="update_anchor_group_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="wireless",
            function="delete_anchor_group_by_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessSettingsAnchorGroupsIdV1(self._task.args, catalystcenter)
