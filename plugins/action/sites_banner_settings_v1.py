...
class SitesBannerSettingsV1(object):
    ...
    def update_all_params(self):
        new_object_params = {}
        new_object_params['banner'] = self.new_object.get('banner')
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                ...
                function="retrieve_banner_settings_for_a_site_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="network_settings",
            function="set_banner_settings_for_a_site_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SitesBannerSettingsV1(self._task.args, catalystcenter)
