...
class ReportsV1(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params['view_id'] = self.new_object.get('viewId') or \
            self.new_object.get('view_id')
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="reports",
                function="get_list_of_scheduled_reports_v1",
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.catalystcenter.exec(
                family="reports",
                function="get_a_scheduled_report_v1",
                params={"report_id": id}
            )
            if isinstance(items, dict):
                if 'response' in items:
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="reports",
            function="create_or_schedule_a_report_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="reports",
            function="delete_a_scheduled_report_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = ReportsV1(self._task.args, catalystcenter)
