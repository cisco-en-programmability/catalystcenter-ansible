...
class IpamServerSettingV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="system_settings",
            function="creates_configuration_details_of_the_external_ip_a_m_server_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="system_settings",
            function="updates_configuration_details_of_the_external_ip_a_m_server_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="system_settings",
            function="deletes_configuration_details_of_the_external_ip_a_m_server_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = IpamServerSettingV1(self._task.args, catalystcenter)
