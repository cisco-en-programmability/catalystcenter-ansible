...
class SecurityServiceInsertions(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params['fabric_site_name'] = self.new_object.get(
            'fabricSiteName') or self.new_object.get('fabric_site_name')
        return new_object_params

    def create_params(self):
        new_object_params = {}
        new_object_params['siteId'] = self.new_object.get('siteId')
        new_object_params['virtualNetworks'] = self.new_object.get(
            'virtualNetworks')
        return new_object_params
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SecurityServiceInsertions(self._task.args, catalystcenter)
