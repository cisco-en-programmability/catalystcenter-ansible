...
class FabricsFabricIdSwitchWirelessSetting(object):
    ...
    def update_all_params(self):
        ...
        new_object_params['enableWireless'] = self.new_object.get(
            'enableWireless')
        new_object_params['rollingApUpgrade'] = self.new_object.get(
            'rollingApUpgrade')
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="fabric_wireless",
            function="switch_wireless_setting_and_rolling_ap_upgrade_management",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = FabricsFabricIdSwitchWirelessSetting(self._task.args, catalystcenter)
