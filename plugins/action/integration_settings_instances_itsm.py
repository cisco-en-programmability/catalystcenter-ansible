...
class IntegrationSettingsInstancesItsm(object):
    ...
    def get_object_by_id(self, id):
        result = None
        try:
            items = self.catalystcenter.exec(family="itsm_integration", function="get_itsm_integration_setting_by_id", params={"instance_id": id})
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = IntegrationSettingsInstancesItsm(self._task.args, catalystcenter)
