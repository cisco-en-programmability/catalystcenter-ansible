...
class WirelessSettingsPowerProfilesV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="wireless",
                function="get_power_profiles_v1",
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="wireless",
            function="create_power_profile_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessSettingsPowerProfilesV1(self._task.args, catalystcenter)
