...
class SdaFabricDevicesLayer2HandoffsSdaTransitsV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="sda",
            function="add_fabric_devices_layer3_handoffs_with_sda_transit_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="update_fabric_devices_layer3_handoffs_with_sda_transit_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="delete_fabric_device_layer3_handoffs_with_sda_transit_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaFabricDevicesLayer2HandoffsSdaTransitsV1(self._task.args, catalystcenter)
