...
class SdaFabricZonesV1(object):
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="update_fabric_zone_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="delete_fabric_zone_by_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaFabricZonesV1(self._task.args, catalystcenter)
