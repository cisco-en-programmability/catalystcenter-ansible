...
class Snmpv2ReadCommunityCredentialV1(object):
    ...
    def update_all_params(self):
        ...
        new_object_params['credentialType'] = self.new_object.get(
            'credentialType')
        ...
        new_object_params['readCommunity'] = self.new_object.get(
            'readCommunity')
        return new_object_params
    ...
    def get_object_by_name(self, name):
        ...
        try:
            ...
            result = get_dict_result(
                items, 'description', name) or get_dict_result(
                items, 'username', name)
        except Exception:
            result = None
        return result
    ...
    def exists(self):
        ...
        name = self.new_object.get(
            "description") or self.new_object.get("username")
        if o_id:
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="discovery",
            function="create_snmp_read_community_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="discovery",
            function="update_snmp_read_community_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = Snmpv2ReadCommunityCredentialV1(self._task.args, catalystcenter)
