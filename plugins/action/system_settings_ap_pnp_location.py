...
class SystemSettingsApPnpLocation(object):
    def __init__(self, params, catalystcenter):
        self.catalystcenter = catalystcenter
        self.new_object = dict(
            apPnPLocation=params.get("apPnPLocation"),
        )
    ...
    def update_all_params(self):
        new_object_params = {}
        new_object_params["apPnPLocation"] = self.new_object.get("apPnPLocation")
        return new_object_params
    ...
    def get_object_by_name(self, name):
        ...
        try:
            ...
            if isinstance(items, dict):
                if "apPnPLocation" in items:
                    items = items.get("apPnPLocation")
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SystemSettingsApPnpLocation(self._task.args, catalystcenter)
