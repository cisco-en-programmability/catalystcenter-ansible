...
class ProjectsProjectIdV1(object):
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="configuration_templates",
            function="update_template_project_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="configuration_templates",
            function="delete_template_project_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = ProjectsProjectIdV1(self._task.args, catalystcenter)
