...
class SdaFabricSitesV1(object):
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="update_fabric_site_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="delete_fabric_site_by_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaFabricSitesV1(self._task.args, catalystcenter)
