...
class SecurityThreatsRogueAllowedListV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="devices",
            function="add_allowed_mac_address_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="devices",
            function="remove_allowed_mac_address_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SecurityThreatsRogueAllowedListV1(self._task.args, catalystcenter)
