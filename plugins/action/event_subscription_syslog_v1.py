...
class EventSubscriptionSyslogV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="event_management",
            function="create_syslog_event_subscription_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="event_management",
            function="update_syslog_event_subscription_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = EventSubscriptionSyslogV1(self._task.args, catalystcenter)
