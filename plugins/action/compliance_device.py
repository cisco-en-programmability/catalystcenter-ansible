...
class ComplianceDevice(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params["compliance_status"] = self.new_object.get(
            "complianceStatus"
        ) or self.new_object.get("compliance_status")
        new_object_params["device_uuid"] = self.new_object.get(
            "deviceUuid"
        ) or self.new_object.get("device_uuid")
    ...
    def create_params(self):
        new_object_params = {}
        new_object_params["triggerFull"] = self.new_object.get("triggerFull")
        new_object_params["categories"] = self.new_object.get("categories")
        new_object_params["deviceUuids"] = self.new_object.get("deviceUuids")
        return new_object_params
