...
class SecurityServiceInsertionsId(object):
    ...
    def get_object_by_id(self, id):
        result = None
        try:
            items = self.catalystcenter.exec(family="sda", function="security_service_insertion_by_id", params={"id": id})
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SecurityServiceInsertionsId(self._task.args, catalystcenter)
