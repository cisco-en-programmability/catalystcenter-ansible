...
class HttpWriteCredentialV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="discovery",
            function="create_http_write_credentials_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="discovery",
            function="update_http_write_credentials_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = HttpWriteCredentialV1(self._task.args, catalystcenter)
