...
from ansible_collections.cisco.catalystcenter.plugins.action.templates_template_id_network_profiles_for_sites_profile_id_delete_v1 import ActionModule
