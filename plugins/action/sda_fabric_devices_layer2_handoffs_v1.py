...
class SdaFabricDevicesLayer2HandoffsV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="sda",
            function="add_fabric_devices_layer2_handoffs_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="delete_fabric_device_layer2_handoff_by_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaFabricDevicesLayer2HandoffsV1(self._task.args, catalystcenter)
