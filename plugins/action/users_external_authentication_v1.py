...
class UsersExternalAuthenticationV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="user_and_roles",
            function="manage_external_authentication_setting_api_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = UsersExternalAuthenticationV1(self._task.args, catalystcenter)
