...
class NetworkDeviceMaintenanceSchedulesV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="devices",
            function="create_maintenance_schedule_for_network_devices_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworkDeviceMaintenanceSchedulesV1(self._task.args, catalystcenter)
