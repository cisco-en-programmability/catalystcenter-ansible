...
class SdaPortChannelsV1(object):
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="update_port_channels_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="delete_port_channel_by_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaPortChannelsV1(self._task.args, catalystcenter)
