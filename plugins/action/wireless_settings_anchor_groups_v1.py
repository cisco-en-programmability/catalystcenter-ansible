...
class WirelessSettingsAnchorGroupsV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="wireless",
            function="create_anchor_group_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessSettingsAnchorGroupsV1(self._task.args, catalystcenter)
