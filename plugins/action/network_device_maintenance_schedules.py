...
class NetworkDeviceMaintenanceSchedules(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params["network_device_ids"] = self.new_object.get("networkDeviceIds") or self.new_object.get("network_device_ids")
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworkDeviceMaintenanceSchedules(self._task.args, catalystcenter)
