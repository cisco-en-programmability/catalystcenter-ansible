...
class QosDeviceInterfaceV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="application_policy",
            function="create_qos_device_interface_info_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="application_policy",
            function="update_qos_device_interface_info_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="application_policy",
            function="delete_qos_device_interface_info_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = QosDeviceInterfaceV1(self._task.args, catalystcenter)
