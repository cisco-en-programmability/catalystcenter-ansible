...
class DeviceRebootAprebootV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="wireless",
                function="get_access_point_reboot_task_result_v1",
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="wireless",
            function="reboot_access_points_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = DeviceRebootAprebootV1(self._task.args, catalystcenter)
