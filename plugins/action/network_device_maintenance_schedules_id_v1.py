...
class NetworkDeviceMaintenanceSchedulesIdV1(object):
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="devices",
            function="updates_the_maintenance_schedule_information_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="devices",
            function="delete_maintenance_schedule_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworkDeviceMaintenanceSchedulesIdV1(self._task.args, catalystcenter)
