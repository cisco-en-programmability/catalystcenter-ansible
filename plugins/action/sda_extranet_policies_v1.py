...
class SdaExtranetPoliciesV1(object):
    ...
    def get_object_by_name(self, name, is_absent=False):
        ...
        try:
            items = self.catalystcenter.exec(
                family="sda",
                function="get_extranet_policies_v1",
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="sda",
            function="add_extranet_policy_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="update_extranet_policy_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="delete_extranet_policy_by_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaExtranetPoliciesV1(self._task.args, catalystcenter)
