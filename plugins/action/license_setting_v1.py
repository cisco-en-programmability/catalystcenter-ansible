...
class LicenseSettingV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="licenses",
                function="retrieve_license_setting_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="licenses",
            function="update_license_setting_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = LicenseSettingV1(self._task.args, catalystcenter)
