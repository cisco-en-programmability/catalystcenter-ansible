...
from ansible_collections.cisco.catalystcenter.plugins.action.network_bugs_results_network_devices_network_device_id_bugs_count_v1_info import ActionModule
