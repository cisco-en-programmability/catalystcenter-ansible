...
class SdaMulticastVirtualNetworksV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="sda",
            function="add_multicast_virtual_networks_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="update_multicast_virtual_networks_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="delete_multicast_virtual_network_by_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaMulticastVirtualNetworksV1(self._task.args, catalystcenter)
