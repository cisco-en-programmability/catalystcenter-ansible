...
class NetworkDevicesResyncIntervalSettingsIdV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="devices",
                function="get_resync_interval_for_the_network_device_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="devices",
            function="update_resync_interval_for_the_network_device_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworkDevicesResyncIntervalSettingsIdV1(self._task.args, catalystcenter)
