...
class SdaAnycastGatewaysV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="sda",
            function="add_anycast_gateways_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="update_anycast_gateways_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="delete_anycast_gateway_by_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaAnycastGatewaysV1(self._task.args, catalystcenter)
