...
class IpamSiteIpAddressPoolsIdV1(object):
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.catalystcenter.exec(
                ...
                function="retrieves_an_ip_address_subpool_v1",
                params={"id": id}
            )
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="network_settings",
            function="release_an_ip_address_subpool_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = IpamSiteIpAddressPoolsIdV1(self._task.args, catalystcenter)
