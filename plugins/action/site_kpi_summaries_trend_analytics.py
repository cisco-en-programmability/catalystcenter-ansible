...
class SiteKpiSummariesTrendAnalytics(object):
    ...
    def create_params(self):
        ...
        new_object_params['trendInterval'] = self.new_object.get(
            'trendInterval')
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="sites",
            function="submit_request_for_site_analytics_trend_data",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SiteKpiSummariesTrendAnalytics(self._task.args, catalystcenter)
