...
class WirelessSettingsDot11BeProfiles(object):
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.catalystcenter.exec(
                family="wireless",
                function="get80211be_profile_by_id_v1",
                params={"id": id}
            )
            if isinstance(items, dict):
                if 'response' in items:
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="wireless",
            function="create_a80211be_profile_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="wireless",
            function="update80211be_profile_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="wireless",
            function="delete_a80211be_profile_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessSettingsDot11BeProfiles(self._task.args, catalystcenter)
