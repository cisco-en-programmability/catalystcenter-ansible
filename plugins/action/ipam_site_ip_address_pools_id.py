...
class IpamSiteIpAddressPoolsId(object):
    ...
    def get_object_by_id(self, id):
        result = None
        try:
            items = self.catalystcenter.exec(family="network_settings", function="retrieves_an_ip_address_subpool", params={"id": id})
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = IpamSiteIpAddressPoolsId(self._task.args, catalystcenter)
