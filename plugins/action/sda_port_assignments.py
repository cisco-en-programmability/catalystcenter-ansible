...
class SdaPortAssignments(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params["data_vlan_name"] = self.new_object.get("dataVlanName") or self.new_object.get("data_vlan_name")
        new_object_params["voice_vlan_name"] = self.new_object.get("voiceVlanName") or self.new_object.get("voice_vlan_name")
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaPortAssignments(self._task.args, catalystcenter)
