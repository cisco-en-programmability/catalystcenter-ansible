...
class EventSubscriptionV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                ...
                function="get_event_subscriptions_v1",
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="event_management",
            function="create_event_subscriptions_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="event_management",
            function="update_event_subscriptions_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="event_management",
            function="delete_event_subscriptions_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = EventSubscriptionV1(self._task.args, catalystcenter)
