...
class SiteKpiSummariesSummaryAnalyticsV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="sites",
                function="get_site_analytics_summary_data_for_the_given_task_id_v1",
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="sites",
            function="submit_request_for_site_analytics_summary_data_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SiteKpiSummariesSummaryAnalyticsV1(self._task.args, catalystcenter)
