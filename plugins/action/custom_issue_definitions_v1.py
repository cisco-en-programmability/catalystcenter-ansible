...
class CustomIssueDefinitionsV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="issues",
            function="creates_a_new_user_defined_issue_definitions_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="issues",
            function="updates_an_existing_custom_issue_definition_based_on_the_provided_id_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="issues",
            function="deletes_an_existing_custom_issue_definition_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = CustomIssueDefinitionsV1(self._task.args, catalystcenter)
