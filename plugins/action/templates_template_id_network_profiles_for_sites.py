...
class TemplatesTemplateIdNetworkProfilesForSites(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params["template_id"] = self.new_object.get("templateId") or self.new_object.get("template_id")
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = TemplatesTemplateIdNetworkProfilesForSites(self._task.args, catalystcenter)
