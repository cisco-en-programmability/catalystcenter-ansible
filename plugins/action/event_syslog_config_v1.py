...
class EventSyslogConfigV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="event_management",
            function="create_syslog_destination_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="event_management",
            function="update_syslog_destination_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = EventSyslogConfigV1(self._task.args, catalystcenter)
