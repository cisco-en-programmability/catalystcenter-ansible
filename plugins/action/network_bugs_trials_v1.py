...
class NetworkBugsTrialsV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="compliance",
                function="get_trial_details_for_bugs_detection_on_network_devices_v1",
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="compliance",
            function="creates_a_trial_for_bugs_detection_on_network_devices_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworkBugsTrialsV1(self._task.args, catalystcenter)
