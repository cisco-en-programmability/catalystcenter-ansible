...
class NetconfCredentialV1(object):
    ...
    def create_params(self):
        new_object_params = {}
        payload = {}
        keys = ["comments", "credentialType", "description", "id", "instanceTenantId", "instanceUuid", "netconfPort"]
        for key in keys:
    ...
    def requires_update(self, current_obj):
        ...
        return any(
            not catalystcenter_compare_equality(current_obj.get(catalyst_param), requested_obj.get(ansible_param))
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="discovery",
            function="create_netconf_credentials_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="discovery",
            function="update_netconf_credentials_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetconfCredentialV1(self._task.args, catalystcenter)
