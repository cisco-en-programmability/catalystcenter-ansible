...
class DeviceCredentialCreate(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                ...
                function="get_device_credential_details_v1",
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="network_settings",
            function="create_device_credentials_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="network_settings",
            function="update_device_credentials_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="network_settings",
            function="delete_device_credential_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = DeviceCredentialCreate(self._task.args, catalystcenter)
