...
required_if = [
    ("state", "present", ["policyId", "ruleId", "siteId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class CompliancePolicysSitesRulesVariables(object):
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = CompliancePolicysSitesRulesVariables(self._task.args, catalystcenter)
