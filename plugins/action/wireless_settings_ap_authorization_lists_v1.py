...
class WirelessSettingsApAuthorizationListsV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="wireless",
                function="get_ap_authorization_lists_v1",
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="wireless",
            function="create_ap_authorization_list_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessSettingsApAuthorizationListsV1(self._task.args, catalystcenter)
