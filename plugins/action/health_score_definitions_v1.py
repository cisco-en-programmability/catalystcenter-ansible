...
class HealthScoreDefinitionsV1(object):
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.catalystcenter.exec(
                family="devices",
                function="get_health_score_definition_for_the_given_id_v1",
                params={"id": id}
            )
            if isinstance(items, dict):
                if 'response' in items:
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="devices",
            function="update_health_score_definition_for_the_given_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = HealthScoreDefinitionsV1(self._task.args, catalystcenter)
