...
required_if = [
    ("state", "present", ["id", "name", "policyId"], True),
    ("state", "absent", ["id", "name", "policyId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class CompliancePolicysRules(object):
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="compliance",
            function="update_an_existing_rule",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="compliance",
            function="delete_a_specific_rule",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = CompliancePolicysRules(self._task.args, catalystcenter)
