...
class FlexibleReportScheduleV1(object):
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.catalystcenter.exec(
                family="reports",
                function="get_flexible_report_schedule_by_report_id_v1",
                params={"report_id": id}
            )
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="reports",
            function="update_schedule_of_flexible_report_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = FlexibleReportScheduleV1(self._task.args, catalystcenter)
