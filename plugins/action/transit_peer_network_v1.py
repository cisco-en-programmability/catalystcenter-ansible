...
class TransitPeerNetworkV1(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params['transit_peer_network_name'] = self.new_object.get(
            'transitPeerNetworkName') or self.new_object.get('transit_peer_network_name')
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="sda",
            function="add_transit_peer_network_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="delete_transit_peer_network_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = TransitPeerNetworkV1(self._task.args, catalystcenter)
