...
class CiscoImcsIdV1(object):
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="cisco_i_m_c",
            function="updates_the_cisco_i_m_c_configuration_for_a_catalyst_center_node_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="cisco_i_m_c",
            function="deletes_the_cisco_i_m_c_configuration_for_a_catalyst_center_node_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = CiscoImcsIdV1(self._task.args, catalystcenter)
