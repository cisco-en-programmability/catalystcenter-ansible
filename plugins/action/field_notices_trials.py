...
class FieldNoticesTrials(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="compliance",
            function="creates_a_trial_for_field_notices_detection_on_network_devices",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = FieldNoticesTrials(self._task.args, catalystcenter)
