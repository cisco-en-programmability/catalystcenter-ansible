...
class FabricsFabricIdWirelessMulticastV1(object):
    ...
    def update_all_params(self):
        new_object_params = {}
        new_object_params['multicastEnabled'] = self.new_object.get(
            'multicastEnabled')
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="fabric_wireless",
            function="update_sda_wireless_multicast_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = FabricsFabricIdWirelessMulticastV1(
