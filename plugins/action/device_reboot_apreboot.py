...
class DeviceRebootApreboot(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params["parent_task_id"] = self.new_object.get("parentTaskId") or self.new_object.get("parent_task_id")
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = DeviceRebootApreboot(self._task.args, catalystcenter)
