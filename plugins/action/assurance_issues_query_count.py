...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        response = catalystcenter.exec(
            family="issues",
            # No function
            # Metadata: {'type': 'c', 'look_by': '', 'urls': ['/dna/data/api/v1/assuranceIssues/query/count'], 'tag': 'Issues', 'version_added': '6.15.0', 'get_all': 'get_the_total_number_of_issues_for_given_set_of_filters_v1', 'get_all_access_resources': "['filters']", 'get_all_access_resources_list': ['filters'], 'operation_id_list': ['get:GetTheTotalNumberOfIssuesForGivenSetOfFiltersV1'], 'description': 'get:Returns the total number issues for given set of filters. If there is no start and/or end time, then end time will be defaulted to current time and start time will be defaulted to 24-hours ago from end time. For detailed information about the usage of the API, please refer to the Open API specification document - https://github.com/cisco-en-programmability/catalyst-center-api-specs/blob/main/Assurance/CE_Cat_Center_Org-IssuesList-1.0.0-resolved.yaml.\n', 'method_url': 'get:post /dna/data/api/v1/assuranceIssues/query/count,\n'}
