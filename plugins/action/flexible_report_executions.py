...
class FlexibleReportExecutions(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params["report_id"] = self.new_object.get(
            "reportId"
        ) or self.new_object.get("report_id")
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = FlexibleReportExecutions(self._task.args, catalystcenter)
