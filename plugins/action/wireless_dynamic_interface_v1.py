...
class WirelessDynamicInterfaceV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="wireless",
                function="get_dynamic_interface_v1",
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="wireless",
            function="create_update_dynamic_interface_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="wireless",
            function="delete_dynamic_interface_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessDynamicInterfaceV1(self._task.args, catalystcenter)
