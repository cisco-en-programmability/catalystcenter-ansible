...
class Snmpv3CredentialV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="discovery",
            function="create_snmpv3_credentials_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="discovery",
            function="update_snmpv3_credentials_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = Snmpv3CredentialV1(self._task.args, catalystcenter)
