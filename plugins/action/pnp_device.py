...
class PnpDevice(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params["onb_state"] = self.new_object.get("onbState") or self.new_object.get("onb_state")
        ...
        new_object_params["workflow_id"] = self.new_object.get("workflowId") or self.new_object.get("workflow_id")
        new_object_params["workflow_name"] = self.new_object.get("workflowName") or self.new_object.get("workflow_name")
        new_object_params["smart_account_id"] = self.new_object.get("smartAccountId") or self.new_object.get("smart_account_id")
        new_object_params["virtual_account_id"] = self.new_object.get("virtualAccountId") or self.new_object.get("virtual_account_id")
        new_object_params["last_contact"] = self.new_object.get("lastContact") or self.new_object.get("last_contact")
        ...
        new_object_params["site_name"] = self.new_object.get("siteName") or self.new_object.get("site_name")
    ...
    def get_object_by_id(self, id):
        result = None
        try:
            items = self.catalystcenter.exec(family="device_onboarding_pnp", function="get_device_by_id", params={"id": id})
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = PnpDevice(self._task.args, catalystcenter)
