...
class IpamGlobalIpAddressPoolsId(object):
    ...
    def get_object_by_id(self, id):
        result = None
        try:
            items = self.catalystcenter.exec(family="network_settings", function="retrieves_a_global_ip_address_pool", params={"id": id})
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = IpamGlobalIpAddressPoolsId(self._task.args, catalystcenter)
