...
class SnmpPropertiesV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="discovery",
                function="get_snmp_properties_v1",
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="discovery",
            function="create_update_snmp_properties_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SnmpPropertiesV1(self._task.args, catalystcenter)
