...
class TagMemberV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="tag",
                function="get_tag_members_by_id_v1",
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="tag",
            function="add_members_to_the_tag_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = TagMemberV1(self._task.args, catalystcenter)
