...
class SitesNtpSettingsV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                ...
                function="retrieve_n_t_p_settings_for_a_site_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="network_settings",
            function="set_n_t_p_settings_for_a_site_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SitesNtpSettingsV1(self._task.args, catalystcenter)
