...
class SdaFabricDevicesLayer2HandoffsIpTransitsV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="sda",
            function="add_fabric_devices_layer3_handoffs_with_ip_transit_v1",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="update_fabric_devices_layer3_handoffs_with_ip_transit_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="sda",
            function="delete_fabric_device_layer3_handoff_with_ip_transit_by_id_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = SdaFabricDevicesLayer2HandoffsIpTransitsV1(self._task.args, catalystcenter)
