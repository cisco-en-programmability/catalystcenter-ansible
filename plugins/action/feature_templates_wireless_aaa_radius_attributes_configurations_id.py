    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.catalystcenter.exec(
                family="wireless", function="get_aaa_radius_attributes_configuration_feature_template", params={"id": id}
            )
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = FeatureTemplatesWirelessAaaRadiusAttributesConfigurationsId(self._task.args, catalystcenter)
