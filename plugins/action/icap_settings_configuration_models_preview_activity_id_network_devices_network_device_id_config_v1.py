...
class IcapSettingsConfigurationModelsPreviewActivityIdNetworkDevicesNetworkDeviceIdConfigV1(
        object):
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = IcapSettingsConfigurationModelsPreviewActivityIdNetworkDevicesNetworkDeviceIdConfigV1(
