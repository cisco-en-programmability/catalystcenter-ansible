...
class ConfigurationTemplateV1(object):
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="configuration_templates",
            function="deletes_the_template_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = ConfigurationTemplateV1(self._task.args, catalystcenter)
