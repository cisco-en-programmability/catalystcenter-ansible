...
class FabricsFabricIdSwitchWirelessSettingV1(object):
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="fabric_wireless",
            function="switch_wireless_setting_and_rolling_ap_upgrade_management_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = FabricsFabricIdSwitchWirelessSettingV1(
