...
argument_spec.update(
    dict(
        ...
        mandatory=dict(type="bool"),
        inputType=dict(type="str"),
        selectionList=dict(type="list"),
        defaultValue=dict(type="str"),
        maxLength=dict(type="int"),
        validationRegex=dict(type="str"),
...
class CompliancePolicysRulesVariables(object):
    def __init__(self, params, catalystcenter):
        ...
        self.new_object = dict(
            ...
            selectionList=params.get("selectionList"),
            defaultValue=params.get("defaultValue"),
            maxLength=params.get("maxLength"),
            validationRegex=params.get("validationRegex"),
    ...
    def create_params(self):
        ...
        new_object_params["mandatory"] = self.new_object.get("mandatory")
        new_object_params["inputType"] = self.new_object.get("inputType")
        new_object_params["selectionList"] = self.new_object.get("selectionList")
        new_object_params["defaultValue"] = self.new_object.get("defaultValue")
        new_object_params["maxLength"] = self.new_object.get("maxLength")
        new_object_params["validationRegex"] = self.new_object.get("validationRegex")
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="compliance",
                function="retrieve_the_variables",
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.catalystcenter.exec(
                family="compliance",
                function="retrieve_a_specific_variable",
                params={"id": id},
            )
            if isinstance(items, dict):
                if "response" in items:
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="compliance",
            function="create_a_new_variable",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="compliance",
            function="update_an_existing_variable",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="compliance",
            function="delete_a_specific_variable",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = CompliancePolicysRulesVariables(self._task.args, catalystcenter)
