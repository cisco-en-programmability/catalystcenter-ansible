...
class NetworkProfilesForSitesSiteAssignmentsV1(object):
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="site_design",
            function="assign_a_network_profile_for_sites_to_the_given_site_v1",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="site_design",
            function="unassigns_a_network_profile_for_sites_from_a_site_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworkProfilesForSitesSiteAssignmentsV1(self._task.args, catalystcenter)
