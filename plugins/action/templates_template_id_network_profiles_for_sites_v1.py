...
class TemplatesTemplateIdNetworkProfilesForSitesV1(object):
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                ...
                function="retrieve_the_network_profiles_attached_to_acl_i_template_v1",
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="configuration_templates",
            function="attach_network_profile_to_a_day_n_cli_template_v1",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = TemplatesTemplateIdNetworkProfilesForSitesV1(self._task.args, catalystcenter)
