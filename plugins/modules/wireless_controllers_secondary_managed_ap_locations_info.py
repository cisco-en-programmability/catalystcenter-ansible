...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Wireless GetSecondaryManagedAPLocationsForSpecificWirelessControllerV1
...
- name: Get all Wirelesscontrollers Secondarymanagedaplocations
  cisco.catalystcenter.wirelessControllers_secondaryManagedApLocations_info:
