...
DOCUMENTATION = r"""
---
module: sda_transitNetworks_count_info
short_description: Information module for Sda Transitnetworks Count
description:
- Get all Sda Transitnetworks Count.
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for SDA GetTransitNetworksCountV1
...
EXAMPLES = r"""
- name: Get all Sda Transitnetworks Count
  cisco.catalystcenter.sda_transitNetworks_count_info:
