...
- Large-scale deployments with many device families and KPIs may require
  increased C(catalystcenter_api_task_timeout) values for complete data extraction.
...
seealso:
- module: cisco.catalystcenter.assurance_device_health_score_settings_workflow_manager
...
class AssuranceDeviceHealthScorePlaybookGenerator(CatalystCenterBase, BrownFieldHelper):
    ...
    Notes:
        ...
        - Large-scale deployments with many device families may require increased
          catalystcenter_api_task_timeout values for complete data extraction
