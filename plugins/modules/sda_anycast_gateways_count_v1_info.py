...
DOCUMENTATION = r"""
---
module: sda_anycast_gateways_count_v1_info
short_description: Information module for Sda Anycast Gateways Count V1
description:
- Get all Sda Anycast Gateways Count V1.
...
EXAMPLES = r"""
- name: Get all Sda Anycast Gateways Count V1
  cisco.catalystcenter.sda_anycast_gateways_count_v1_info:
