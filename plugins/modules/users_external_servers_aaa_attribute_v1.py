...
description:
- Manage operations create and delete of the resource Users External Servers Aaa Attribute V1.
- >
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.users_external_servers_aaa_attribute_v1:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
