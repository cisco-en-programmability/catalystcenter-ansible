...
DOCUMENTATION = r"""
---
module: images_v1_info
short_description: Information module for Images V1
description:
  - Get all Images V1.
  - >
    A list of available images for the specified site is provided. The default value
    of the site is set to global. The
    list includes images that have been imported onto the disk, as well as the latest
    and suggested images from
    Cisco.com.
...
"""
EXAMPLES = r"""
- name: Get all Images V1
  cisco.catalystcenter.images_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
