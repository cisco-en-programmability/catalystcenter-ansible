...
DOCUMENTATION = r"""
---
module: sda_fabrics_vlan_to_ssids_fabric_id_v1_info
short_description: Information module for Sda Fabrics Vlan To Ssids Fabric Id V1
description:
  - Get all Sda Fabrics Vlan To Ssids Fabric Id V1.
  - >
    Retrieve the VLANs and SSIDs mapped to the VLAN, within a Fabric Site. The 'fabricId'
    represents the Fabric ID of
...
"""
EXAMPLES = r"""
- name: Get all Sda Fabrics Vlan To Ssids Fabric Id V1
  cisco.catalystcenter.sda_fabrics_vlan_to_ssids_fabric_id_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
