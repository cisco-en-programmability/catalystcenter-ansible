      ...
      authentication_policy_server:
        ...
        suboptions:
          ...
          pxgrid_enabled:
            ...
            type: bool
            default: true
          use_catalystcenter_cert_for_pxgrid:
...
class IseRadiusIntegration(CatalystCenterBase):
    ...
    def get_want_authentication_policy_server(self, auth_policy_server):
        ...
        for item in auth_policy_server:
            ...
            if auth_server.get("isIseEnabled"):
                ...
                use_catalystcenter_cert_for_pxgrid = item.get("use_catalystcenter_cert_for_pxgrid")
                if use_catalystcenter_cert_for_pxgrid is None:
                    if auth_server_exists:
                        use_catalystcenter_cert_for_pxgrid = auth_server_details.get("useDnacCertForPxgrid")
                    else:
                        use_catalystcenter_cert_for_pxgrid = False

                auth_server.update({"useDnacCertForPxgrid": use_catalystcenter_cert_for_pxgrid})
    ...
    def check_ise_server_integration_status(self, ip_address):
        ...
        while True:
            try:
                cisco_ise_status = self.catalystcenter._exec(
                    family="system_settings",
...
def main():
    ...
    if ccc_ise_radius.compare_catalystcenter_versions(ccc_ise_radius.get_ccc_version(), "2.3.7.0") < 0:
        ccc_ise_radius.msg = (
