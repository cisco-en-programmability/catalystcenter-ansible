...
short_description: Information module for Interfaces Count
description:
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Devices GetInterfacesTotalCount
...
- name: Get all Interfaces Count
  cisco.catalystcenter.interfaces_count_info:
