...
short_description: Information module for Interfaces Count Info
description:
- This module represents an alias of the module interfaces_count_v1_info
...
notes:
  ...
  - It should be noted that this module is an alias of interfaces_count_v1_info
