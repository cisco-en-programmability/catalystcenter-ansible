...
DOCUMENTATION = r"""
---
module: sda_fabric_devices_layer2handoffs_sda_transits_count_info
short_description: Information module for Sda Fabric
  Devices Layer2handoffs Sda Transits Count
description:
...
- name: Get all Sda Fabric Devices Layer2handoffs Sda
    Transits Count
  cisco.catalystcenter.sda_fabric_devices_layer2handoffs_sda_transits_count_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
