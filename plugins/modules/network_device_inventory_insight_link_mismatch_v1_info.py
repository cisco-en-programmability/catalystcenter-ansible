...
DOCUMENTATION = r"""
---
module: network_device_inventory_insight_link_mismatch_v1_info
short_description: Information module for Network Device Inventory Insight Link Mismatch V1
description:
- Get all Network Device Inventory Insight Link Mismatch V1.
...
EXAMPLES = r"""
- name: Get all Network Device Inventory Insight Link Mismatch V1
  cisco.catalystcenter.network_device_inventory_insight_link_mismatch_v1_info:
