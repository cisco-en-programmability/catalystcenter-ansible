...
DOCUMENTATION = r"""
---
module: clients_query_v1
short_description: Resource module for Clients Query V1
description:
  - Manage operation create of the resource Clients Query V1.
  - >
    Retrieves the list of clients by applying complex filters while also supporting
    aggregate attributes. For detailed
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.clients_query_v1:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
