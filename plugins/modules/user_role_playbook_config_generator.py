...
seealso:
- module: cisco.catalystcenter.user_role_workflow_manager
...
def main():
    ...
    ccc_user_role_playbook_generator.log(
        ...
        "catalystcenter_username={2}, catalystcenter_verify={3}, catalystcenter_version={4}, state={5}".format(
