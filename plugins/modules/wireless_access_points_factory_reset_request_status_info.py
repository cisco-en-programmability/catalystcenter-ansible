...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Wireless GetAccessPointsFactoryResetStatusV1
...
- name: Get all Wirelessaccesspoints Factoryresetrequeststatus
  cisco.catalystcenter.wirelessAccessPoints_factoryResetRequestStatus_info:
