...
def main():
    ...
    catalystcenter_credential = DnacCredential(module)
    ...
    for config in catalystcenter_credential.config:
        ...
        catalystcenter_credential.get_diff_state_apply[state](config).check_return_status()
        if config_verify:
            catalystcenter_credential.verify_diff_state_apply[state](config).check_return_status()
