...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Configuration Templates ExportsTheProjectsForAGivenCriteriaV1
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.configuration_template_export_project:
