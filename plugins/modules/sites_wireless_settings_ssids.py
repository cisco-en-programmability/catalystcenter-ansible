...
short_description: Resource module for Sites Wireless
  Settings Ssids
description:
  - Manage operations create, update and delete of the
    resource Sites Wireless Settings Ssids.
  - This API allows the user to create an SSID Service
    Set Identifier at the Global site. - > This API
    allows the user to delete an SSID Service Set Identifier
    at the global level , if the SSID is not mapped
    to any Wireless Profile, Or remove override from
    given site Id .
  - This API allows the user to update an SSID Service
...
options:
  ...
  authType:
    description: L2 Authentication Type (If authType
      ...
      Default is L2 Authentication Type if exists else
      None.
    type: str
  ...
  basicServiceSetMaxIdleEnable:
    ...
    type: bool
  cckmTsfTolerance:
    description: He default value is the Cckm Timestamp
  ...
  clientExclusionTimeout:
    description: This refers to the length of time,
      ...
      of unsuccessful attempts. Default is Client Exclusion
      Timeout if exists else 180.
    type: int
  clientRateLimit:
    description: This pertains to the maximum data transfer
      rate, specified in bits per second, that a client
      is permitted to achieve. It should be in mutliples
      of 500. Default is Client Rate Limit if exists
      else 0.
    type: int
  ...
  managementFrameProtectionClientprotection:
    description: Default is Management Frame Protection
      Client if exists else Optional.
    type: str
  multiPSKSettings:
  ...
  policyProfileName:
    description: "Policy Profile Name. If 'policyProfileName'
      is not provided, the value of 'profileName' will
      be assigned to it. If 'profileName' is also not
      provided, an autogenerated name will be used.
      Autogenerated name is generated by appending 'ssid'
      field's value with '_profile' (Example If 'ssid'
      = 'ExampleSsid', then autogenerated name will
      be 'ExampleSsid_profile')."
    type: str
  profileName:
  ...
  removeOverrideInHierarchy:
    description: RemoveOverrideInHierarchy query parameter.
      Remove override in hierarchy. Refer Feature tab
      for details.
    type: bool
  ...
  sessionTimeOutEnable:
    ...
    type: bool
  siteId:
    description: SiteId path parameter. Site UUID of
      Global site.
    type: str
  ...
  sleepingClientTimeout:
    description: This refers to the amount of time,
      ...
      client is timed out of the network. Default is
      Sleeping Client Timeout if exists else 720.
    type: int
  ssid:
...
seealso:
  - name: Cisco DNA Center documentation for Wireless
      CreateSSID
    description: Complete reference of the CreateSSID
      API.
    link: https://developer.cisco.com/docs/dna-center/#!create-ssid
  - name: Cisco DNA Center documentation for Wireless
      DeleteSSID
    description: Complete reference of the DeleteSSID
      API.
    link: https://developer.cisco.com/docs/dna-center/#!delete-ssid
  - name: Cisco DNA Center documentation for Wireless
      UpdateSSID
    description: Complete reference of the UpdateSSID
      API.
