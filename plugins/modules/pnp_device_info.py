...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Device Onboarding (PnP) GetDeviceByIdV1
...
- name: Cisco CATALYST Center documentation for Device Onboarding (PnP) GetDeviceListSiteManagementV1
...
- name: Get all Pnp Device
  cisco.catalystcenter.pnp_device_info:
