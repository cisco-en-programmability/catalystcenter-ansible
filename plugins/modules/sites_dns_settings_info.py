...
short_description: Information module for Sites Dns
  Settings
description:
  - Get all Sites Dns Settings. - > Retrieve DNS settings
...
seealso:
  - name: Cisco DNA Center documentation for Network
      Settings RetrieveDNSSettingsForASite
    description: Complete reference of the RetrieveDNSSettingsForASite
      API.
