...
DOCUMENTATION = r"""
---
module: sites_dnsSettings_info
short_description: Information module for Sites Dnssettings
description:
- Get all Sites Dnssettings.
- >
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Network Settings RetrieveDNSSettingsForASiteV1
...
EXAMPLES = r"""
- name: Get all Sites Dnssettings
  cisco.catalystcenter.sites_dnsSettings_info:
