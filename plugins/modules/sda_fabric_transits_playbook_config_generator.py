...
seealso:
- module: cisco.catalystcenter.sda_fabric_transits_workflow_manager
...
class SdaFabricTransitsPlaybookConfigGenerator(CatalystCenterBase, BrownFieldHelper):
    """
