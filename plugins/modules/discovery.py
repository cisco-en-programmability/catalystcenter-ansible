...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Discovery StartDiscoveryV1
...
- name: Cisco CATALYST Center documentation for Discovery DeleteAllDiscoveryV1
...
- name: Cisco CATALYST Center documentation for Discovery DeleteDiscoveryByIdV1
...
- name: Cisco CATALYST Center documentation for Discovery UpdatesAnExistingDiscoveryBySpecifiedIdV1
...
EXAMPLES = r"""
- name: Delete all
  cisco.catalystcenter.discovery:
