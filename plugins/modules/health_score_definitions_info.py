...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Devices GetAllHealthScoreDefinitionsForGivenFiltersV1
...
- name: Cisco CATALYST Center documentation for Devices GetHealthScoreDefinitionForTheGivenIdV1
...
- name: Get all Healthscoredefinitions
  cisco.catalystcenter.healthScoreDefinitions_info:
