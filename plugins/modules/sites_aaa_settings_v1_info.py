...
DOCUMENTATION = r"""
---
module: sites_aaa_settings_v1_info
short_description: Information module for Sites Aaa Settings V1
description:
  - Get all Sites Aaa Settings V1.
  - >
    Retrieve AAA settings for a site; `null` values indicate that the setting will
...
"""
EXAMPLES = r"""
- name: Get all Sites Aaa Settings V1
  cisco.catalystcenter.sites_aaa_settings_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
