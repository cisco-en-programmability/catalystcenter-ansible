...
DOCUMENTATION = r"""
---
module: sites_imageDistributionSettings_info
short_description: Information module for Sites Imagedistributionsettings
description:
- Get all Sites Imagedistributionsettings.
- >
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Network Settings RetrieveImageDistributionSettingsForASiteV1
  description: Complete reference of the RetrieveImageDistributionSettingsForASiteV1 API.
  link: https://developer.cisco.com/docs/dna-center/#!retrieve-image-distribution-settings-for-a-site-v-1
notes:
  - SDK Method used are
...
EXAMPLES = r"""
- name: Get all Sites Imagedistributionsettings
  cisco.catalystcenter.sites_imageDistributionSettings_info:
