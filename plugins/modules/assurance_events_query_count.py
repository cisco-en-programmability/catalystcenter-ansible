...
DOCUMENTATION = r"""
---
module: assuranceEvents_query_count
short_description: Resource module for Assuranceevents Query Count
description:
- Manage operation create of the resource Assuranceevents Query Count.
- >
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Devices CountTheNumberOfEventsWithFiltersV1
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.assuranceEvents_query_count:
