...
DOCUMENTATION = r"""
---
module: ipam_site_ip_address_pools_v1
short_description: Resource module for Ipam Site Ip Address Pools V1
description:
    ...
    suboptions:
      assignedAddresses:
        description: The number of addresses assigned from the pool. This is a numeric
          ...
          has a value up to 128 bits for IPv6 address spaces and 32 bits for IPv4 address
          spaces.
        type: str
      ...
      subnet:
        ...
        type: str
      totalAddresses:
        description: The total number of addresses in the pool. This is a numeric string;
          since IPv6 address spaces are 128 bits in size, presume this string has a
          value up to 128 bits for IPv6 address spaces and 32 bits for IPv4 address
          spaces.
        type: str
      unassignableAddresses:
        description: The number of addresses in the pool that cannot be assigned. This
          is a numeric string; since IPv6 address spaces are 128 bits in size, presume
          this string has a value up to 128 bits for IPv6 address spaces and 32 bits
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.ipam_site_ip_address_pools_v1:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
