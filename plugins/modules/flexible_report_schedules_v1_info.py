...
DOCUMENTATION = r"""
---
module: flexible_report_schedules_v1_info
short_description: Information module for Flexible Report Schedules V1
description:
- Get all Flexible Report Schedules V1.
...
EXAMPLES = r"""
- name: Get all Flexible Report Schedules V1
  cisco.catalystcenter.flexible_report_schedules_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
