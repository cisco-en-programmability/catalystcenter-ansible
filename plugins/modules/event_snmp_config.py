...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Event Management CreateSNMPDestinationV1
...
- name: Cisco CATALYST Center documentation for Event Management UpdateSNMPDestinationV1
