...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Site Design RetrievesTheCountOfNetworkProfilesForSitesV1
...
- name: Get all Networkdevices Networkprofilesforsites Count
  cisco.catalystcenter.networkDevices_networkProfilesForSites_count_info:
