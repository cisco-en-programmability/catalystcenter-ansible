...
short_description: Information module for Network Devices Network Profiles For Sites Count Info
description:
- This module represents an alias of the module network_devices_network_profiles_for_sites_count_v1_info
...
notes:
  ...
  - It should be noted that this module is an alias of network_devices_network_profiles_for_sites_count_v1_info

"""

EXAMPLES = r"""
- name: Get all Network Devices Network Profiles For Sites Count Info
