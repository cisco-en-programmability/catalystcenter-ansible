...
DOCUMENTATION = r"""
---
module: sites_imageDistributionSettings
short_description: Resource module for Sites Imagedistributionsettings
description:
- Manage operation update of the resource Sites Imagedistributionsettings.
- >
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Network Settings SetImageDistributionSettingsForASiteV1
...
EXAMPLES = r"""
- name: Update all
  cisco.catalystcenter.sites_imageDistributionSettings:
