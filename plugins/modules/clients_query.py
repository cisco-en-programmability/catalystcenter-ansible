...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Clients RetrievesTheListOfClientsByApplyingComplexFiltersWhileAlsoSupportingAggregateAttributesV1
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.clients_query:
