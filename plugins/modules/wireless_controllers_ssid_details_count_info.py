...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Wireless GetSSIDCountForSpecificWirelessControllerV1
...
- name: Get all Wirelesscontrollers Ssiddetails Count
  cisco.catalystcenter.wirelessControllers_ssidDetails_count_info:
