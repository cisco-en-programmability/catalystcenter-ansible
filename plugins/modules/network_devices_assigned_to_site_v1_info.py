...
DOCUMENTATION = r"""
---
module: network_devices_assigned_to_site_v1_info
short_description: Information module for Network Devices Assigned To Site V1
description:
  - Get all Network Devices Assigned To Site V1.
  - >
    Get all site assigned network devices. The items in the list are arranged in an
    order that corresponds with their
...
"""
EXAMPLES = r"""
- name: Get all Network Devices Assigned To Site V1
  cisco.catalystcenter.network_devices_assigned_to_site_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
