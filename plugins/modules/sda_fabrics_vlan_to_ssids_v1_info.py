...
DOCUMENTATION = r"""
---
module: sda_fabrics_vlan_to_ssids_v1_info
short_description: Information module for Sda Fabrics Vlan To Ssids V1
description:
- Get all Sda Fabrics Vlan To Ssids V1.
...
EXAMPLES = r"""
- name: Get all Sda Fabrics Vlan To Ssids V1
  cisco.catalystcenter.sda_fabrics_vlan_to_ssids_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
