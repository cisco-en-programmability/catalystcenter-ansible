...
DOCUMENTATION = r"""
---
module: dhcp_services_count_v1_info
short_description: Information module for Dhcp Services Count V1
description:
  - Get all Dhcp Services Count V1.
  - >
...
seealso:
  - name: Cisco DNA Center documentation for Devices RetrievesTheTotalNumberOfDHCPServicesForGivenParametersV1
    description: Complete reference of the RetrievesTheTotalNumberOfDHCPServicesForGivenParametersV1
      API.
    link:
      https://developer.cisco.com/docs/dna-center/#!retrieves-the-total-number-of-dhcp-services-for-given-parameters
notes:
  - SDK Method used are
    devices.Devices.retrieves_the_total_number_of_d_h_c_p_services_for_given_parameters_v1,
  - Paths used are get /dna/data/api/v1/dhcpServices/count,
"""
EXAMPLES = r"""
- name: Get all Dhcp Services Count V1
  cisco.catalystcenter.dhcp_services_count_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
