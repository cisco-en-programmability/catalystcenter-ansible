...
DOCUMENTATION = r"""
---
module: event_subscription_syslog_v1
short_description: Resource module for Event Subscription Syslog V1
description:
- Manage operations create and update of the resource Event Subscription Syslog V1.
...
EXAMPLES = r"""
- name: Update all
  cisco.catalystcenter.event_subscription_syslog_v1:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
