...
DOCUMENTATION = r"""
---
module: images_site_wise_product_names_v1_info
short_description: Information module for Images Site Wise Product Names V1
description:
  - Get all Images Site Wise Product Names V1.
  - >
    Returns a list of network device product names and associated sites for a given
    image identifier. Refer
...
"""
EXAMPLES = r"""
- name: Get all Images Site Wise Product Names V1
  cisco.catalystcenter.images_site_wise_product_names_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
