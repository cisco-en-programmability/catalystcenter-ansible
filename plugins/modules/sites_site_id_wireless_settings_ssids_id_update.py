...
description:
- This module represents an alias of the module sites_site_id_wireless_settings_ssids_id_update_v1
...
notes:
  ...
  - It should be noted that this module is an alias of sites_site_id_wireless_settings_ssids_id_update_v1
