...
DOCUMENTATION = r"""
---
module: network_profiles_for_sites_site_assignments_v1_info
short_description: Information module for Network Profiles For Sites Site Assignments V1
description:
- Get all Network Profiles For Sites Site Assignments V1.
...
EXAMPLES = r"""
- name: Get all Network Profiles For Sites Site Assignments V1
  cisco.catalystcenter.network_profiles_for_sites_site_assignments_v1_info:
