...
---
module: sensor_v1
short_description: Resource module for Sensor V1
description:
  - Manage operations create and delete of the resource Sensor V1.
  - Intent API to create a SENSOR test template with a new SSID, existing SSID, or
    both new and existing SSID.
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.sensor_v1:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
