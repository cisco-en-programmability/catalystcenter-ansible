...
short_description: Resource module for Images Id Sites
  Site Id Untag Golden
description:
  - Manage operation create of the resource Images Id
    Sites Site Id Untag Golden. - > Untag the golden
    images specifically designed for a particular device
    type or supervisor engine module. Conditions for
...
seealso:
  - name: Cisco DNA Center documentation for Software
      Image Management (SWIM) UntaggingGoldenImage
    description: Complete reference of the UntaggingGoldenImage
      API.
...
---
- name: Create
  cisco.catalystcenter.images_id_sites_site_id_untag_golden:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
