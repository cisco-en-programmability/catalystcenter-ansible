...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Software Image Management (SWIM) UntaggingGoldenImage
    description: Complete reference of the UntaggingGoldenImage API.
