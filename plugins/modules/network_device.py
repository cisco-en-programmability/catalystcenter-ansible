...
options:
  ...
  httpPort:
    ...
    type: str
  httpSecure:
    description: Flag to select HTTP / HTTPS protocol. Options are true / false. True for HTTPS and false for HTTP. Default
      is true.
    type: bool
  httpUserName:
  ...
  merakiOrgId:
    ...
    type: list
  netconfPort:
    description: Netconf Port of the device. CliTransport must be 'ssh' if netconf is provided. Netconf port is required for
      eWLC.
    type: str
  password:
  ...
  snmpPrivProtocol:
    ...
    type: str
  snmpROCommunity:
    description: SNMP Read Community of the device. If snmpVersion is v2, at least one of snmpROCommunity and snmpRWCommunity
      is required.
    type: str
  snmpRWCommunity:
    description: SNMP Write Community of the device. If snmpVersion is v2, at least one of snmpROCommunity and snmpRWCommunity
      is required.
    type: str
  snmpRetry:
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Devices AddDevice
...
---
- name: Create
  cisco.catalystcenter.network_device:
