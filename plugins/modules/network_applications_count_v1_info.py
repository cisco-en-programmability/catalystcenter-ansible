...
description:
  ...
  - >
    Retrieves the number of network applications by applying basic filtering. If startTime
    and endTime are not
    provided, the API defaults to the last 24 hours. `siteId` is mandatory. `siteId`
...
- name: Get all Network Applications Count V1
  cisco.catalystcenter.network_applications_count_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
