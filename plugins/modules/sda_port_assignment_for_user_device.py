...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for SDA AddPortAssignmentForUserDeviceInSDAFabricV1
...
- name: Cisco CATALYST Center documentation for SDA DeletePortAssignmentForUserDeviceInSDAFabricV1
