...
DOCUMENTATION = r"""
---
module: configuration_template_clone_v1
short_description: Resource module for Configuration Template Clone V1
description:
- Manage operation create of the resource Configuration Template Clone V1.
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.configuration_template_clone_v1:
