...
DOCUMENTATION = r"""
---
module: networkDevices_issues_remediation_provision
short_description: Resource module for Networkdevices Issues Remediation Provision
description:
- Manage operation create of the resource Networkdevices Issues Remediation Provision.
- >
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Compliance ComplianceRemediationV1
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.networkDevices_issues_remediation_provision:
