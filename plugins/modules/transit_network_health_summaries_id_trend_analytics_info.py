...
short_description: Information module for Transit Network Health Summaries Id Trend Analytics
description:
...
seealso:
  - name: Cisco DNA Center documentation for SDA TheTrendAnalyticsDataForATransitNetworkInTheSpecifiedTimeRange
    description: Complete reference of the TheTrendAnalyticsDataForATransitNetworkInTheSpecifiedTimeRange API.
...
EXAMPLES = r"""
---
- name: Get all Transit Network Health Summaries Id Trend Analytics
