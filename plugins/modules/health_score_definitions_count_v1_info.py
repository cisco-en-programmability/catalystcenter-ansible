...
DOCUMENTATION = r"""
---
module: health_score_definitions_count_v1_info
short_description: Information module for Health Score Definitions Count V1
description:
- Get all Health Score Definitions Count V1.
- >
...
EXAMPLES = r"""
- name: Get all Health Score Definitions Count V1
  cisco.catalystcenter.health_score_definitions_count_v1_info:
