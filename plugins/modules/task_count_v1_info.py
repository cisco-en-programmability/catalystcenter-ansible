...
DOCUMENTATION = r"""
---
module: task_count_v1_info
short_description: Information module for Task Count V1
description:
- Get all Task Count V1.
- Returns Task count.
version_added: '3.1.0'
...
EXAMPLES = r"""
- name: Get all Task Count V1
  cisco.catalystcenter.task_count_v1_info:
