...
options:
  ...
  serverIp:
    description:
      - >
        ServerIp query parameter. IP Address of the DHCP Server. This parameter supports wildcard (`*`)
        character -based search. Example `10.76.81.*` or `*56.78*` or `*50.28` Examples serverIp=10.42.3.31
        (single IP Address is requested) serverIp=10.42.3.31&serverIp=name2&fabricVnName=name3 (multiple IP
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Devices RetrievesTheDetailsOfASpecificDHCPServiceMatchingTheIdOfTheService
    description: Complete reference of the RetrievesTheDetailsOfASpecificDHCPServiceMatchingTheIdOfTheService API.
  ...
  - name: Cisco DNA Center documentation for Devices RetrievesTheListOfDHCPServicesForGivenParameters
    description: Complete reference of the RetrievesTheListOfDHCPServicesForGivenParameters API.
