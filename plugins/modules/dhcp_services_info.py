...
- name: Cisco DNA Center documentation for Devices RetrievesTheListOfDHCPServicesForGivenParametersV1
  description: Complete reference of the RetrievesTheListOfDHCPServicesForGivenParametersV1 API.
  link: https://developer.cisco.com/docs/dna-center/#!retrieves-the-list-of-dhcp-services-for-given-parameters
notes:
  - SDK Method used are
    devices.Devices.retrieves_the_list_of_d_h_c_p_services_for_given_parameters_v1,
