...
short_description: Information module for Dhcp Services Info
description:
  - This module represents an alias of the module dhcp_services_v1_info
...
options:
  ...
  serverIp:
    description:
      - >
        ServerIp query parameter. IP Address of the DHCP Server. This parameter supports
        wildcard (`*`) character
...
requirements:
  ...
  - python >= 3.5
seealso:
  - name: Cisco DNA Center documentation for Devices RetrievesTheListOfDHCPServicesForGivenParametersV1
    description: Complete reference of the RetrievesTheListOfDHCPServicesForGivenParametersV1
      API.
    link:
      https://developer.cisco.com/docs/dna-center/#!retrieves-the-list-of-dhcp-services-for-given-parameters
notes:
  - SDK Method used are devices.Devices.retrieves_the_list_of_d_h_c_p_services_for_given_parameters_v1,
  - Paths used are get /dna/data/api/v1/dhcpServices,
  - It should be noted that this module is an alias of dhcp_services_v1_info
"""
EXAMPLES = r"""
- name: Get all Dhcp Services Info
  cisco.catalystcenter.dhcp_services_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
