...
- Use C(catalystcenter_log) and C(catalystcenter_log_level) parameters for detailed
...
seealso:
- module: cisco.catalystcenter.rma_workflow_manager
...
class RMAPlaybookGenerator(CatalystCenterBase, BrownFieldHelper):
    """
...
def main():
    ...
    ccc_rma_playbook_generator.log(
        "Module initialized with parameters: catalystcenter_host={0}, catalystcenter_port={1}, "
        "catalystcenter_username={2}, catalystcenter_verify={3}, catalystcenter_version={4}, state={5}, "
        "config_items={6}".format(
            module.params.get("catalystcenter_host"),
            module.params.get("catalystcenter_port"),
