...
short_description: Resource module for Icap Settings Configuration Models Id Delete Deploy V1
description:
- Manage operation create of the resource Icap Settings Configuration Models Id Delete Deploy V1.
- >
   Creates a ICAP configuration intent to remove the ICAP RFSTATS or ANOMALY configuration from the device. The task
   has not been applied to the device yet. Subsequent preview-approve workflow APIs must be used to complete the
   preview-approve process. The path parameter 'id' can be retrieved from **GET /dna/intent/api/v1/icapSettings**
   API. For detailed information about the usage of the API, please refer to the Open API specification document -
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.icap_settings_configuration_models_id_delete_deploy_v1:
