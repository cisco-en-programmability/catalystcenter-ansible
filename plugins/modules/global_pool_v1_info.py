...
DOCUMENTATION = r"""
---
module: global_pool_v1_info
short_description: Information module for Global Pool V1
description:
- Get all Global Pool V1.
...
EXAMPLES = r"""
- name: Get all Global Pool V1
  cisco.catalystcenter.global_pool_v1_info:
