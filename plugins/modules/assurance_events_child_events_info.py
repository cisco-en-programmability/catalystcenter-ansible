...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Devices GetListOfChildEventsForTheGivenWirelessClientEvent
    description: Complete reference of the GetListOfChildEventsForTheGivenWirelessClientEvent API.
