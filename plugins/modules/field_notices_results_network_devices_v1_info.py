...
DOCUMENTATION = r"""
---
module: field_notices_results_network_devices_v1_info
short_description: Information module for Field Notices Results Network Devices V1
description:
- Get all Field Notices Results Network Devices V1.
...
EXAMPLES = r"""
- name: Get all Field Notices Results Network Devices V1
  cisco.catalystcenter.field_notices_results_network_devices_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
