...
DOCUMENTATION = r"""
---
module: templates_details_v2_info
short_description: Information module for Templates Details V2
description:
- Get all Templates Details V2.
...
- name: Get all Templates Details V2
  cisco.catalystcenter.templates_details_v2_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
