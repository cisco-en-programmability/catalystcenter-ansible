...
short_description: Information module for Application Visibility Network Devices
description:
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Application Policy RetrieveTheListOfNetworkDevicesWithTheirApplicationVisibilityStatus
    description: Complete reference of the RetrieveTheListOfNetworkDevicesWithTheirApplicationVisibilityStatus API.
