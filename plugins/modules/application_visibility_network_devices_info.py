...
short_description: Information module for Application Visibility Network Devices Info
description:
  - This module represents an alias of the module application_visibility_network_devices_v1_info
...
notes:
  ...
  - It should be noted that this module is an alias of application_visibility_network_devices_v1_info
"""
EXAMPLES = r"""
- name: Get all Application Visibility Network Devices Info
  cisco.catalystcenter.application_visibility_network_devices_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
