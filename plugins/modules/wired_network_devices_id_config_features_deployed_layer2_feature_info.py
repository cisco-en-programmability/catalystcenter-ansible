...
short_description: Information module for Wired Network Devices Id Config Features Deployed Layer2 Feature
description:
...
options:
  ...
  feature:
    description:
      - >
        Feature path parameter. Name of the feature to retrieve Layer 2 configuration for. The API
...
seealso:
  - name: Cisco DNA Center documentation for Wired GetConfigurationsForADeployedLayer2FeatureOnAWiredDevice
    description: Complete reference of the GetConfigurationsForADeployedLayer2FeatureOnAWiredDevice API.
...
EXAMPLES = r"""
---
- name: Get Wired Network Devices Id Config Features Deployed Layer2 Feature by id
  cisco.catalystcenter.wired_network_devices_id_config_features_deployed_layer2_feature_info:
