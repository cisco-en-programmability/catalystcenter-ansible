...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Software Image Management (SWIM) CountOfNetworkDeviceImageUpdatesV1
...
- name: Get all Networkdeviceimageupdates Count
  cisco.catalystcenter.networkDeviceImageUpdates_count_info:
