...
DOCUMENTATION = r"""
---
module: sda_virtual_network_ip_pool_v1
short_description: Resource module for Sda Virtual Network Ip Pool V1
description:
- Manage operations create and delete of the resource Sda Virtual Network Ip Pool V1.
...
EXAMPLES = r"""
- name: Delete all
  cisco.catalystcenter.sda_virtual_network_ip_pool_v1:
    dnac_host: "{{dnac_host}}"
