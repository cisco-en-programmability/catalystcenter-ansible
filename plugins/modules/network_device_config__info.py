...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Configuration Archive GetConfigurationArchiveDetailsV1
  description: Complete reference of the GetConfigurationArchiveDetailsV1 API.
  link: https://developer.cisco.com/docs/dna-center/#!get-configuration-archive-details-v-1
notes:
  - SDK Method used are
    configuration_archive.ConfigurationArchive.get_configuration_archive_details_v1,
