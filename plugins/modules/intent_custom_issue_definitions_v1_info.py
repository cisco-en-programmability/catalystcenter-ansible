...
DOCUMENTATION = r"""
---
module: intent_custom_issue_definitions_v1_info
short_description: Information module for Intent Custom Issue Definitions V1
description:
- Get Intent Custom Issue Definitions V1 by id.
- >
...
EXAMPLES = r"""
- name: Get Intent Custom Issue Definitions V1 by id
  cisco.catalystcenter.intent_custom_issue_definitions_v1_info:
