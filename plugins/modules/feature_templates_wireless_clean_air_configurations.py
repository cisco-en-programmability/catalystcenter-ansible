...
options:
      ...
      interferersFeatures:
        ...
        suboptions:
          ...
          bluetoothPagingInquiry:
            description: Bluetooth Paging Inquiry is only applicable for Radio Band 2_4GHZ.
            type: bool
          bluetoothScoAcl:
            description: Bluetooth SCO ACL is only applicable for Radio Band 2_4GHZ.
            type: bool
          continuousTransmitter:
            description: Continuous Transmitter is applicable for Radio Bands 2_4GHZ, 5GHZ, 6GHZ.
            type: bool
          genericDect:
          ...
          microwaveOven:
            ...
            type: bool
          motorolaCanopy:
            description: Motorola Canopy is only applicable for Radio Band 2_4GHZ, 5GHZ.
            type: bool
          siFhss:
          ...
          spectrum80211NonStandardChannel:
            description: Spectrum 802.11 Non STD Channel is only applicable for Radio Band 2_4GHZ and 5GHZ.
            type: bool
          spectrum802154:
            description: Spectrum 802.15.4 is only applicable for Radio Band 2_4GHZ.
            type: bool
          spectrumInverted:
            description: Spectrum Inverted is only applicable for Radio Band 2_4GHZ and 5GHZ.
            type: bool
          superAg:
            description: Super AG is only applicable for Radio Band 2_4GHZ and 5GHZ.
            type: bool
          videoCamera:
            description: Video Camera is only applicable for Radio Band 2_4GHZ and 5GHZ.
            type: bool
          wimaxFixed:
            description: WiMAX Fixed is only applicable for Radio Band 2_4GHZ and 5GHZ.
            type: bool
          wimaxMobile:
            description: WiMAX Mobile is only applicable for Radio Band 2_4GHZ and 5GHZ.
            type: bool
          xbox:
  ...
  unlockedAttributes:
    description: Attributes unlocked in design can be changed at device provision time. `Note ` unlockedAttributes can only
      contain the first level attributes defined under featureAttributes.
    elements: str
    type: list
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Wireless CreateCleanAirConfigurationFeatureTemplate
    description: Complete reference of the CreateCleanAirConfigurationFeatureTemplate API.
    link: https://developer.cisco.com/docs/dna-center/#!create-clean-air-configuration-feature-template
  - name: Cisco DNA Center documentation for Wireless DeleteCleanAirConfigurationFeatureTemplate
    description: Complete reference of the DeleteCleanAirConfigurationFeatureTemplate API.
    link: https://developer.cisco.com/docs/dna-center/#!delete-clean-air-configuration-feature-template
  - name: Cisco DNA Center documentation for Wireless UpdateCleanAirConfigurationFeatureTemplate
    description: Complete reference of the UpdateCleanAirConfigurationFeatureTemplate API.
...
---
- name: Create
  cisco.catalystcenter.feature_templates_wireless_clean_air_configurations:
