...
description:
- This module represents an alias of the module dhcp_services_trend_analytics_v1
...
notes:
  ...
  - It should be noted that this module is an alias of dhcp_services_trend_analytics_v1
