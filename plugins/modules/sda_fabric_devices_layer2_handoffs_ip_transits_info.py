...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for SDA GetFabricDevicesLayer3HandoffsWithIpTransitV1
...
- name: Get all Sda Fabricdevices Layer2handoffs Iptransits
  cisco.catalystcenter.sda_fabricDevices_layer2Handoffs_ipTransits_info:
