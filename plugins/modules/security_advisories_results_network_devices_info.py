...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Compliance GetSecurityAdvisoryNetworkDeviceByNetworkDeviceId
    description: Complete reference of the GetSecurityAdvisoryNetworkDeviceByNetworkDeviceId API.
    link: https://developer.cisco.com/docs/dna-center/#!get-security-advisory-network-device-by-network-device-id
  - name: Cisco DNA Center documentation for Compliance GetSecurityAdvisoryNetworkDevices
    description: Complete reference of the GetSecurityAdvisoryNetworkDevices API.
...
EXAMPLES = r"""
---
- name: Get all Security Advisories Results Network Devices
