...
DOCUMENTATION = r"""
---
module: floors_uploadImage
short_description: Resource module for Floors Uploadimage
description:
- Manage operation create of the resource Floors Uploadimage.
- Uploads floor image.
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.floors_uploadImage:
