...
DOCUMENTATION = r"""
---
module: aaa_services_query_v1
short_description: Resource module for Aaa Services Query V1
description:
  - Manage operation create of the resource Aaa Services Query V1.
  - >
    Retrieves the list of AAA Services and offers complex filtering and sorting capabilities.
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.aaa_services_query_v1:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
