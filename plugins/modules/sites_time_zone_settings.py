...
DOCUMENTATION = r"""
---
module: sites_timeZoneSettings
short_description: Resource module for Sites Timezonesettings
description:
- Manage operation update of the resource Sites Timezonesettings.
- >
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Network Settings SetTimeZoneForASiteV1
...
EXAMPLES = r"""
- name: Update all
  cisco.catalystcenter.sites_timeZoneSettings:
