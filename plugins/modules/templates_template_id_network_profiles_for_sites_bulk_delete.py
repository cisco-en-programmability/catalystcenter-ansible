...
options:
  profileId:
    description: ProfileId query parameter. The id or ids of the network profile, retrievable from /dna/intent/api/v1/networkProfilesForSites.
      The maximum number of profile Ids allowed is 20. A list of profile ids can be passed as a queryParameter in two ways
      a comma-separated string ( profileId=388a23e9-4739-4be7-a0aa-cc5a95d158dd,2726dc60-3a12-451e-947a-d9... or... As separate
      query parameters with the same name ( profileId=388a23e9-4739-4be7-a0aa-cc5a95d158dd&profil...
    type: str
  templateId:
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Configuration Templates DetachAListOfNetworkProfilesFromADayNCLITemplate
    description: Complete reference of the DetachAListOfNetworkProfilesFromADayNCLITemplate API.
