...
DOCUMENTATION = r"""
---
module: sda_extranet_policies_count_v1_info
short_description: Information module for Sda Extranet Policies Count V1
description:
- Get all Sda Extranet Policies Count V1.
...
EXAMPLES = r"""
- name: Get all Sda Extranet Policies Count V1
  cisco.catalystcenter.sda_extranet_policies_count_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
