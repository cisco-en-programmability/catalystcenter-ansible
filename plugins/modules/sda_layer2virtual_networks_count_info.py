...
DOCUMENTATION = r"""
---
module: sda_layer2virtual_networks_count_info
short_description: Information module for Sda Layer2virtual
  Networks Count
description:
  - Get all Sda Layer2virtual Networks Count.
...
EXAMPLES = r"""
---
- name: Get all Sda Layer2virtual Networks Count
  cisco.catalystcenter.sda_layer2virtual_networks_count_info:
    dnac_host: "{{dnac_host}}"
