...
short_description: Resource module for Templates Template Id Network Profiles For Sites Bulk Delete V1
description:
- Manage operation delete of the resource Templates Template Id Network Profiles For Sites Bulk Delete V1.
...
EXAMPLES = r"""
- name: Delete all
  cisco.catalystcenter.templates_template_id_network_profiles_for_sites_bulk_delete_v1:
