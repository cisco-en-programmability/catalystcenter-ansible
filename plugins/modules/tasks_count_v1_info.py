...
DOCUMENTATION = r"""
---
module: tasks_count_v1_info
short_description: Information module for Tasks Count V1
description:
  - Get all Tasks Count V1.
...
"""
EXAMPLES = r"""
- name: Get all Tasks Count V1
  cisco.catalystcenter.tasks_count_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
