...
short_description: Information module for Icap Spectrum Interference Device Reports V1
description:
...
- name: Get all Icap Spectrum Interference Device Reports V1
  cisco.catalystcenter.icap_spectrum_interference_device_reports_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
