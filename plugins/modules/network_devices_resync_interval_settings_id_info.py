...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Devices GetResyncIntervalForTheNetworkDeviceV1
...
- name: Get all Networkdevices Resyncintervalsettings Id
  cisco.catalystcenter.networkDevices_resyncIntervalSettings_id_info:
