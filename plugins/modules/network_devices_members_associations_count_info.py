...
DOCUMENTATION = r"""
---
module: network_devices_members_associations_count_info
short_description: Information module for Network Devices Members Associations Count
description:
...
- name: Get all Network Devices Members Associations Count
  cisco.catalystcenter.network_devices_members_associations_count_info:
