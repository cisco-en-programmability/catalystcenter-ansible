...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Site Design RetrievesTheCountOfSitesThatTheGivenNetworkProfileForSitesIsAssignedToV1
...
- name: Get all Networkprofilesforsites Siteassignments Count
  cisco.catalystcenter.networkProfilesForSites_siteAssignments_count_info:
