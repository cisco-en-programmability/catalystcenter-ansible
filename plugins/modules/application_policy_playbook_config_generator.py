...
def main():
    ...
    ccc_app_policy_generator.log(
        "Module initialized at timestamp {0} with parameters: catalystcenter_host={1}, "
        "catalystcenter_port={2}, catalystcenter_username={3}, catalystcenter_verify={4}, catalystcenter_version={5}, "
