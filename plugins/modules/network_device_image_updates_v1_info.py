...
DOCUMENTATION = r"""
---
module: network_device_image_updates_v1_info
short_description: Information module for Network Device Image Updates V1
description:
...
- name: Get all Network Device Image Updates V1
  cisco.catalystcenter.network_device_image_updates_v1_info:
