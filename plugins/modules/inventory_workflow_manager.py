...
class Inventory(CatalystCenterBase):
    ...
    def provision_wired_device_v1(self, device_ip, site_name_hierarchy, device_type):
        ...
        try:
            response = self.catalystcenter._exec(family="sda", function='provision_wired_device', op_modifies=True, params=provision_params)
    ...
    def provision_device(self, provision_params, device_ip):
        ...
        try:
            response = self.catalystcenter._exec(family="sda", function='provision_devices', op_modifies=True, params={"payload": provision_params})
