...
short_description: Information module for Network Devices Intent Info
description:
- This module represents an alias of the module network_devices_intent_v1_info
...
options:
  ...
  managementState:
    description:
    - >
      ManagementState query parameter. The status of the network device's manageability. Available statuses are
  ...
  views:
    ...
    - >
      ...
      If multiple views are provided, the response will contain the union of the views. Refer features for more
  ...
  sortBy:
    description:
    - >
      SortBy query parameter. A property within the response to sort by. Available values id, managementAddress,
      dnsResolvedManagementIpAddress, hostname, macAddress, type, family, series, platformids, softwareType,
      softwareVersion, vendor, bootTime, role, roleSource, apEthernetMacAddress, apManagerInterfaceIpAddress,
      apWlcIpAddress, deviceSupportLevel, reachabilityFailureReason, resyncStartTime, resyncEndTime,
      resyncReasons, pendingResyncRequestCount, pendingResyncRequestReasons, resyncIntervalSource,
...
- python >= 3.5
seealso:
- name: Cisco DNA Center documentation for Devices RetrieveNetworkDevicesV1
  description: Complete reference of the RetrieveNetworkDevicesV1 API.
  link: https://developer.cisco.com/docs/dna-center/#!retrieve-network-devices
notes:
  - SDK Method used are
    devices.Devices.retrieve_network_devices_v1,

  - Paths used are
    get /dna/intent/api/v1/networkDevices,
  - It should be noted that this module is an alias of network_devices_intent_v1_info

"""

EXAMPLES = r"""
- name: Get all Network Devices Intent Info
