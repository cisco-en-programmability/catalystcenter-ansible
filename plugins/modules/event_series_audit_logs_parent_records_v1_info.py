...
DOCUMENTATION = r"""
---
module: event_series_audit_logs_parent_records_v1_info
short_description: Information module for Event Series Audit Logs Parent Records V1
description:
- Get all Event Series Audit Logs Parent Records V1.
...
EXAMPLES = r"""
- name: Get all Event Series Audit Logs Parent Records V1
  cisco.catalystcenter.event_series_audit_logs_parent_records_v1_info:
