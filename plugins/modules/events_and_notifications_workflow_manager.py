...
class Events(CatalystCenterBase):
    ...
    def syslog_dest_needs_update(self, syslog_details, syslog_details_in_ccc):
        ...
        for key, value in syslog_details.items():
            if key == "server_address":
                if syslog_details_in_ccc["_host"] != value:
                    update_needed = True
                    break
    ...
    def update_syslog_destination(self, syslog_details, syslog_details_in_ccc):
        ...
        try:
            ...
            update_syslog_params['_host'] = syslog_details.get('server_address') or syslog_details_in_ccc.get('_host')
