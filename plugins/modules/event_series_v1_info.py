...
DOCUMENTATION = r"""
---
module: event_series_v1_info
short_description: Information module for Event Series V1
description:
  - Get all Event Series V1.
...
"""
EXAMPLES = r"""
- name: Get all Event Series V1
  cisco.catalystcenter.event_series_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
