...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Network Settings CreateDeviceCredentialsV1
...
- name: Cisco CATALYST Center documentation for Network Settings DeleteDeviceCredentialV1
...
- name: Cisco CATALYST Center documentation for Network Settings UpdateDeviceCredentialsV1
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.device_credential_create:
