...
options:
  ...
  timeoutSeconds:
    ...
    type: str
  usecatalystcenterCertForPxgrid:
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for System Settings AddAuthenticationAndPolicyServerAccessConfigurationV1
...
- name: Cisco CATALYST Center documentation for System Settings DeleteAuthenticationAndPolicyServerAccessConfigurationV1
...
- name: Cisco CATALYST Center documentation for System Settings EditAuthenticationAndPolicyServerAccessConfigurationV1
...
- name: Create
  cisco.catalystcenter.authentication_policy_servers:
    ...
    usecatalystcenterCertForPxgrid: true
