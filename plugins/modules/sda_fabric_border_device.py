...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for SDA AddBorderDeviceInSDAFabricV1
...
- name: Cisco CATALYST Center documentation for SDA DeleteBorderDeviceFromSDAFabricV1
