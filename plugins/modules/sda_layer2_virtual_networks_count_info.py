...
DOCUMENTATION = r"""
---
module: sda_layer2VirtualNetworks_count_info
short_description: Information module for Sda Layer2virtualnetworks Count
description:
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for SDA GetLayer2VirtualNetworkCountV1
...
- name: Get all Sda Layer2virtualnetworks Count
  cisco.catalystcenter.sda_layer2VirtualNetworks_count_info:
