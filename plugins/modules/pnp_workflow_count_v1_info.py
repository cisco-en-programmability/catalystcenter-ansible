...
DOCUMENTATION = r"""
---
module: pnp_workflow_count_v1_info
short_description: Information module for Pnp Workflow Count V1
description:
- Get all Pnp Workflow Count V1.
...
EXAMPLES = r"""
- name: Get all Pnp Workflow Count V1
  cisco.catalystcenter.pnp_workflow_count_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
