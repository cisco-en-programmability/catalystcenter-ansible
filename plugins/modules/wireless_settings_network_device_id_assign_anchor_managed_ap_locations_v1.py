...
short_description: Resource module for Wireless Settings Network Device Id Assign Anchor Managed Ap Locations V1
description:
- Manage operation create of the resource Wireless Settings Network Device Id Assign Anchor Managed Ap Locations V1.
- >
   This API allows user to assign Anchor Managed AP Locations for WLC by device ID. The payload should always be a
   complete list. The Managed AP Locations included in the payload will be fully processed for both addition and
   deletion.
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.wireless_settings_network_device_id_assign_anchor_managed_ap_locations_v1:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
