...
short_description: Information module for Site Health Summaries Trend Analytics Info
description:
- This module represents an alias of the module site_health_summaries_trend_analytics_v1_info
...
- name: Cisco DNA Center documentation for Sites ReadTrendAnalyticsDataForAGroupingOfSitesInYourNetworkV1
  description: Complete reference of the ReadTrendAnalyticsDataForAGroupingOfSitesInYourNetworkV1 API.
...
notes:
  ...
  - It should be noted that this module is an alias of site_health_summaries_trend_analytics_v1_info

"""

EXAMPLES = r"""
- name: Get all Site Health Summaries Trend Analytics Info
  cisco.catalystcenter.site_health_summaries_trend_analytics_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
