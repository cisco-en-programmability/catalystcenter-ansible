...
- >
   ...
   sites. The data will be grouped based on the specified trend time interval. For detailed information about the
...
- name: Get all Site Health Summaries Trend Analytics V1
  cisco.catalystcenter.site_health_summaries_trend_analytics_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
