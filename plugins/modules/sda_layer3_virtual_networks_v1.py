...
DOCUMENTATION = r"""
---
module: sda_layer3_virtual_networks_v1
short_description: Resource module for Sda Layer3 Virtual Networks V1
description:
- Manage operations create, update and delete of the resource Sda Layer3 Virtual Networks V1.
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.sda_layer3_virtual_networks_v1:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
