...
DOCUMENTATION = r"""
---
module: lan_automation_status_v1_info
short_description: Information module for Lan Automation Status V1
description:
  - Get all Lan Automation Status V1.
  - Get Lan Automation Status V1 by id.
  - Invoke this API to get the LAN Automation session status based on the given Lan
...
"""
EXAMPLES = r"""
- name: Get all Lan Automation Status V1
  cisco.catalystcenter.lan_automation_status_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
    ...
    limit: 0
  register: result
- name: Get Lan Automation Status V1 by id
  cisco.catalystcenter.lan_automation_status_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
