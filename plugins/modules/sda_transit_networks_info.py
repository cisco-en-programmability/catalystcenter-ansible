...
DOCUMENTATION = r"""
---
module: sda_transitNetworks_info
short_description: Information module for Sda Transitnetworks
description:
- Get all Sda Transitnetworks.
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for SDA GetTransitNetworksV1
...
EXAMPLES = r"""
- name: Get all Sda Transitnetworks
  cisco.catalystcenter.sda_transitNetworks_info:
