...
options:
  dataLinkEncryption:
    description: A secure link in which data is encrypted using CAPWAP DTLS protocol can be established between two controllers.
      This value will be applied to all peers during POST operation.
    type: bool
  dtlsHighCipher:
  ...
  mobilityPeers:
    ...
    suboptions:
      ...
      peerIp:
        ...
        type: str
      peerNetworkDeviceId:
        description: The possible values are UNKNOWN or valid UUID of Network device Id. UNKNOWN represents out of band device
          which is not managed internally. Valid UUID represents WLC network device id.
        type: str
      privateIpAddress:
