...
DOCUMENTATION = r"""
---
module: planned_access_points_v1_info
short_description: Information module for Planned Access Points V1
description:
- Get all Planned Access Points V1.
...
EXAMPLES = r"""
- name: Get all Planned Access Points V1
  cisco.catalystcenter.planned_access_points_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
