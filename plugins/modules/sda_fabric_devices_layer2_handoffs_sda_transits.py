...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for SDA AddFabricDevicesLayer3HandoffsWithSdaTransitV1
...
- name: Cisco CATALYST Center documentation for SDA DeleteFabricDeviceLayer3HandoffsWithSdaTransitV1
...
- name: Cisco CATALYST Center documentation for SDA UpdateFabricDevicesLayer3HandoffsWithSdaTransitV1
...
EXAMPLES = r"""
- name: Update all
  cisco.catalystcenter.sda_fabricDevices_layer2Handoffs_sdaTransits:
