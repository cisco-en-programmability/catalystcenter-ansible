...
DOCUMENTATION = r"""
---
module: dns_services_v1_info
short_description: Information module for Dns Services V1
description:
- Get all Dns Services V1.
- >
...
EXAMPLES = r"""
- name: Get all Dns Services V1
  cisco.catalystcenter.dns_services_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
