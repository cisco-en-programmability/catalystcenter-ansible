...
short_description: Information module for Network Bugs Results Network Devices Network
  Device Id Bugs Info
description:
  - This module represents an alias of the module network_bugs_results_network_devices_network_device_id_bugs_v1_info
...
notes:
  - SDK Method used are compliance.Compliance.get_bugs_affecting_the_network_device_v1,
  - Paths used are get /dna/intent/api/v1/networkBugs/results/networkDevices/{networkDeviceId}/bugs,
  - It should be noted that this module is an alias of network_bugs_results_network_devices_network_device_id_bugs_v1_info
"""
EXAMPLES = r"""
- name: Get all Network Bugs Results Network Devices Network Device Id Bugs Info
  cisco.catalystcenter.network_bugs_results_network_devices_network_device_id_bugs_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
