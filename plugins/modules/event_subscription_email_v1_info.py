...
DOCUMENTATION = r"""
---
module: event_subscription_email_v1_info
short_description: Information module for Event Subscription Email V1
description:
  - Get all Event Subscription Email V1.
...
"""
EXAMPLES = r"""
- name: Get all Event Subscription Email V1
  cisco.catalystcenter.event_subscription_email_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
