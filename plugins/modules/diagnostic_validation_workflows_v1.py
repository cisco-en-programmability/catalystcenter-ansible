...
DOCUMENTATION = r"""
---
module: diagnostic_validation_workflows_v1
short_description: Resource module for Diagnostic Validation Workflows V1
description:
...
seealso:
  - name: Cisco DNA Center documentation for Health and Performance SubmitsTheWorkflowForExecutingValidationsV1
    description: Complete reference of the SubmitsTheWorkflowForExecutingValidationsV1
      API.
    link:
...
notes:
  - SDK Method used are health_and_performance.HealthAndPerformance.deletes_a_validation_workflow_v1,
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.diagnostic_validation_workflows_v1:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
