...
DOCUMENTATION = r"""
---
module: network_applications_v1_info
short_description: Information module for Network Applications V1
description:
- Get all Network Applications V1.
- >
   Retrieves the list of network applications along with experience and health metrics. If startTime and endTime are
   not provided, the API defaults to the last 24 hours. `siteId` is mandatory. `siteId` must be a site UUID of a
...
EXAMPLES = r"""
- name: Get all Network Applications V1
  cisco.catalystcenter.network_applications_v1_info:
