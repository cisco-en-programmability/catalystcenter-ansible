...
DOCUMENTATION = r"""
---
module: client_proximity_v1_info
short_description: Information module for Client Proximity V1
description:
  - Get all Client Proximity V1.
  - >
    This intent API will provide client proximity information for a specific wireless
    user. Proximity is defined as
    presence on the same floor at the same time as the specified wireless user. The
    Proximity workflow requires the
    subscription to the following event via the Event Notification workflow prior
    to making this API call NETWORK-
...
"""
EXAMPLES = r"""
- name: Get all Client Proximity V1
  cisco.catalystcenter.client_proximity_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
