...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for SDA GetFabricDevicesLayer2HandoffsCountV1
...
- name: Get all Sda Fabricdevices Layer2handoffs Count
  cisco.catalystcenter.sda_fabricDevices_layer2Handoffs_count_info:
