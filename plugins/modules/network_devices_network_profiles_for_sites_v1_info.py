...
DOCUMENTATION = r"""
---
module: network_devices_network_profiles_for_sites_v1_info
short_description: Information module for Network Devices Network Profiles For Sites V1
description:
- Get all Network Devices Network Profiles For Sites V1.
- Get Network Devices Network Profiles For Sites V1 by id.
...
EXAMPLES = r"""
- name: Get all Network Devices Network Profiles For Sites V1
  cisco.catalystcenter.network_devices_network_profiles_for_sites_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
...
- name: Get Network Devices Network Profiles For Sites V1 by id
  cisco.catalystcenter.network_devices_network_profiles_for_sites_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
