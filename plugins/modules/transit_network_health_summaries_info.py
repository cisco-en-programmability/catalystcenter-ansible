...
short_description: Information module for Transit Network Health Summaries Info
description:
- This module represents an alias of the module transit_network_health_summaries_v1_info
...
notes:
  ...
  - It should be noted that this module is an alias of transit_network_health_summaries_v1_info

"""

EXAMPLES = r"""
- name: Get all Transit Network Health Summaries Info
  cisco.catalystcenter.transit_network_health_summaries_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
