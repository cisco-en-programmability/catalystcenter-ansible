...
def main():
    ...
    Module Parameters (element_spec):
        Connection Parameters:
            - catalystcenter_host (str, required): Catalyst Center hostname or IP address
            - catalystcenter_port (str, optional): API port number (default: "443")
