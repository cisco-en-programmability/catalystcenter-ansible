...
DOCUMENTATION = r"""
---
module: network_devices_intent_v1_info
short_description: Information module for Network Devices Intent V1
description:
...
- name: Get all Network Devices Intent V1
  cisco.catalystcenter.network_devices_intent_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
