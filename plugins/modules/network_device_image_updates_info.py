...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Software Image Management (SWIM) GetNetworkDeviceImageUpdatesV1
...
- name: Get all Networkdeviceimageupdates
  cisco.catalystcenter.networkDeviceImageUpdates_info:
