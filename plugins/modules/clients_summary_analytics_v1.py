...
DOCUMENTATION = r"""
---
module: clients_summary_analytics_v1
short_description: Resource module for Clients Summary Analytics V1
description:
  - Manage operation create of the resource Clients Summary Analytics V1.
  - >
    Retrieves summary analytics data related to clients while applying complex filtering,
    aggregate functions, and
    grouping. This API facilitates obtaining consolidated insights into the performance
    and status of the clients. For
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.clients_summary_analytics_v1:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
