...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Task GetTasksByIDV1
...
- name: Cisco CATALYST Center documentation for Task GetTasksV1
...
EXAMPLES = r"""
- name: Get all Tasks
  cisco.catalystcenter.tasks_info:
