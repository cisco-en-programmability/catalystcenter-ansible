...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Event Management CreateSyslogDestinationV1
...
- name: Cisco CATALYST Center documentation for Event Management UpdateSyslogDestinationV1
