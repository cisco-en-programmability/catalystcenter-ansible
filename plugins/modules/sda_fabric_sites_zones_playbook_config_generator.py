...
seealso:
- module: cisco.catalystcenter.sda_fabric_sites_zones_workflow_manager
...
- name: Auto-generate YAML Configuration for all components which includes fabric sites and fabric zones.
  cisco.catalystcenter.sda_fabric_sites_zones_playbook_config_generator:
...
class FabricSiteZonePlaybookConfigGenerator(CatalystCenterBase, BrownFieldHelper):
    """
