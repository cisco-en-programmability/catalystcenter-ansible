...
DOCUMENTATION = r"""
---
module: device_interface_ospf_v1_info
short_description: Information module for Device Interface Ospf V1
description:
- Get all Device Interface Ospf V1.
...
EXAMPLES = r"""
- name: Get all Device Interface Ospf V1
  cisco.catalystcenter.device_interface_ospf_v1_info:
