...
DOCUMENTATION = r"""
---
module: sda_layer3_virtual_networks_v1_info
short_description: Information module for Sda Layer3 Virtual Networks V1
description:
- Get all Sda Layer3 Virtual Networks V1.
...
EXAMPLES = r"""
- name: Get all Sda Layer3 Virtual Networks V1
  cisco.catalystcenter.sda_layer3_virtual_networks_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
