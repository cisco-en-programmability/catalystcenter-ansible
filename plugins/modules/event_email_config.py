...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Event Management CreateEmailDestinationV1
...
- name: Cisco CATALYST Center documentation for Event Management UpdateEmailDestinationV1
