...
DOCUMENTATION = r"""
---
module: AssuranceGetSensorTestResults_info
short_description: Information module for Assurancegetsensortestresults
description:
- Get all Assurancegetsensortestresults.
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Wireless SensorTestResultsV1
...
EXAMPLES = r"""
- name: Get all Assurancegetsensortestresults
  cisco.catalystcenter.AssuranceGetSensorTestResults_info:
