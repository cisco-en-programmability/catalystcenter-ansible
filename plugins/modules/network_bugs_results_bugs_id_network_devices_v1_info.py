...
DOCUMENTATION = r"""
---
module: network_bugs_results_bugs_id_network_devices_v1_info
short_description: Information module for Network Bugs Results Bugs Id Network Devices V1
description:
- Get all Network Bugs Results Bugs Id Network Devices V1.
...
EXAMPLES = r"""
- name: Get all Network Bugs Results Bugs Id Network Devices V1
  cisco.catalystcenter.network_bugs_results_bugs_id_network_devices_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
