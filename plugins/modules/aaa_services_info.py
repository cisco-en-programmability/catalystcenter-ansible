...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Devices RetrievesTheDetailsOfASpecificAAAServiceMatchingTheIdOfTheService
    description: Complete reference of the RetrievesTheDetailsOfASpecificAAAServiceMatchingTheIdOfTheService API.
  ...
  - name: Cisco DNA Center documentation for Devices RetrievesTheListOfAAAServicesForGivenParameters
    description: Complete reference of the RetrievesTheListOfAAAServicesForGivenParameters API.
    link: https://developer.cisco.com/docs/dna-center/#!retrieves-the-list-of-aaa-services-for-given-parameters
notes:
  - SDK Method used are
    devices.Devices.retrieves_the_details_of_a_specific_aaa_service_matching_the_id_of_the_service,
...
- name: Get all Aaa Services
  cisco.catalystcenter.aaa_services_info:
