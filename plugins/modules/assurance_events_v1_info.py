...
DOCUMENTATION = r"""
---
module: assurance_events_v1_info
short_description: Information module for Assurance Events V1
description:
  - Get all Assurance Events V1.
  - Get Assurance Events V1 by id.
  - >
    API to fetch the details of an assurance event using event `id`. For detailed
  ...
  - >
    Returns the list of events discovered by Catalyst Center, determined by the complex
    filters. Please refer to the
    'API Support Documentation' section to understand which fields are supported.
...
- name: Get all Assurance Events V1
  cisco.catalystcenter.assurance_events_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
