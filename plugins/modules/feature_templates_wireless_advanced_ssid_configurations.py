  ...
  featureAttributes:
    ...
    suboptions:
      ...
      mDNSMode:
        ...
        type: str
      maxClients:
        description: For physical 9800 series controllers, valid ranges are - 0-5000 for 9800-L series - 0-32000 for 9800-40
          series - 0-64000 for 9800-80 series For 9800-CL series controllers, valid ranges are - 0-10000 for Small (S) VM
          - 0-32000 for Medium (M) VM - 0-64000 for Large (L) VM For Embedded Wireless Controller and Mobility Express, the
          valid range is 0-2000. For the 9300 platform, the valid range is 0-4000. For the AireOS platform, valid ranges are
          - 0-3000 for 3500 series - 0-20000 for 5500 series - 0-64000 for 8500 series.
        type: int
      maxClientsPerAp:
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Wireless CreateAdvancedSSIDConfigurationFeatureTemplate
    description: Complete reference of the CreateAdvancedSSIDConfigurationFeatureTemplate API.
    link: https://developer.cisco.com/docs/dna-center/#!create-advanced-ssid-configuration-feature-template
  - name: Cisco DNA Center documentation for Wireless DeleteAdvancedSSIDConfigurationFeatureTemplate
    description: Complete reference of the DeleteAdvancedSSIDConfigurationFeatureTemplate API.
    link: https://developer.cisco.com/docs/dna-center/#!delete-advanced-ssid-configuration-feature-template
  - name: Cisco DNA Center documentation for Wireless UpdateAdvancedSSIDConfigurationFeatureTemplate
    description: Complete reference of the UpdateAdvancedSSIDConfigurationFeatureTemplate API.
