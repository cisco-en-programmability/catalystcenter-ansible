...
options:
  ...
  limit:
    description:
    - >
      Limit query parameter. Maximum number of records to be fetched. If not provided, 50 records will be fetched
      by default. Maximum 1000 records can be fetched at a time. Use pagination if more records need to be
      fetched.
    type: int
  offset:
    description:
  ...
  include:
    ...
    - >
      ...
      corresponding GET API. 'ANC' - Include ANC policy related details. 'TRUST' - Include trust score details.
    type: str
  epId:
    description:
...
- name: Get all Endpoint Analytics Endpoints V1
  cisco.catalystcenter.endpoint_analytics_endpoints_v1_info:
    dnac_host: "{{dnac_host}}"
