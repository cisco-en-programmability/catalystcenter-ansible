...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Configuration Templates DeletesTheTemplateV1
...
- name: Cisco CATALYST Center documentation for Configuration Templates UpdateTemplateV1
