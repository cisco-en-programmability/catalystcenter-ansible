...
DOCUMENTATION = r"""
---
module: clients_trendAnalytics
short_description: Resource module for Clients Trendanalytics
description:
- Manage operation create of the resource Clients Trendanalytics.
- >
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Clients RetrievesTheTrendAnalyticsDataRelatedToClientsV1
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.clients_trendAnalytics:
