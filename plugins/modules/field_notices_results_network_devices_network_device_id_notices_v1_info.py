...
DOCUMENTATION = r"""
---
module: field_notices_results_network_devices_network_device_id_notices_v1_info
short_description: Information module for Field Notices Results Network Devices Network Device Id Notices V1
description:
- Get all Field Notices Results Network Devices Network Device Id Notices V1.
...
- name: Cisco DNA Center documentation for Compliance GetFieldNoticesAffectingTheNetworkDeviceV1
  description: Complete reference of the GetFieldNoticesAffectingTheNetworkDeviceV1 API.
  link: https://developer.cisco.com/docs/dna-center/#!get-field-notices-affecting-the-network-device
notes:
  - SDK Method used are
    compliance.Compliance.get_field_notices_affecting_the_network_device_v1,
...
EXAMPLES = r"""
- name: Get all Field Notices Results Network Devices Network Device Id Notices V1
  cisco.catalystcenter.field_notices_results_network_devices_network_device_id_notices_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
