  ...
  radioType6GHzProperties:
    ...
    suboptions:
      ...
      customRxSopThreshold:
        ...
        type: int
      dataRates:
        description: Data rates of 6 GHz radio band passed in comma separated format without any spaces. Permissible values
      ...
      fraPropertiesC:
        ...
        type: dict
      mandatoryDataRates:
        description: Mandatory data rates of 6 GHz radio band passed in comma separated format without any spaces and must
          be a subset of selected dataRates with maximum of 2 values. Permissible values 6, 9, 12, 18, 24, 36, 48, 54.
        type: str
      maxDbsWidth:
      ...
      powerThresholdV1:
        ...
        type: int
      preamblePuncture:
        description: Enable or Disable Preamble Puncturing. This Wifi 7 configuration is applicable to wireless IOS devices
          supporting 17.15 and higher.
        type: bool
      pscEnforcingEnabled:
        description: PSC Enforcing Enable for 6 GHz radio band.
        type: bool
      radioChannels:
        description: DCA channels of 6 GHz radio band passed in comma separated format without any spaces. Permissible values
  ...
  radioTypeAProperties:
    ...
    suboptions:
      ...
      customRxSopThreshold:
        ...
        type: int
      dataRates:
        description: Data rates of 5 GHz radio band passed in comma separated format without any spaces. Permissible values
          6, 9, 12, 18, 24, 36, 48, 54.
        type: str
      fraPropertiesA:
        ...
        type: dict
      mandatoryDataRates:
        description: Mandatory data rates of 5 GHz radio band passed in comma separated format without any spaces and must
          be a subset of selected dataRates with maximum of 2 values. Permissible values 6, 9, 12, 18, 24, 36, 48, 54.
        type: str
      maxPowerLevel:
      ...
      preamblePuncture:
        ...
        type: bool
      radioChannels:
        description: DCA channels of 5 GHz radio band passed in comma separated format without any spaces. Permissible values
  ...
  radioTypeBProperties:
    ...
    suboptions:
      ...
      customRxSopThreshold:
        ...
        type: int
      dataRates:
        description: Data rates of 2.4 GHz radio band passed in comma separated format without any spaces. Permissible values
          1, 2, 5.5, 6, 9, 11, 12, 18, 24, 36, 48, 54.
        type: str
      mandatoryDataRates:
        description: Mandatory data rates of 2.4 GHz radio band passed in comma separated format without any spaces and must
          be a subset of selected dataRates with maximum of 2 values. Permissible values 1, 2, 5.5, 6, 9, 11, 12, 18, 24,
          36, 48, 54.
        type: str
      maxPowerLevel:
      ...
      powerThresholdV1:
        ...
        type: int
      radioChannels:
        description: DCA channels of 2.4 GHz radio band passed in comma separated format without any spaces. Permissible values
