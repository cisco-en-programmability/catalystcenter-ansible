...
DOCUMENTATION = r"""
---
module: sites_dhcpSettings_info
short_description: Information module for Sites Dhcpsettings
description:
- Get all Sites Dhcpsettings.
- >
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Network Settings RetrieveDHCPSettingsForASiteV1
...
EXAMPLES = r"""
- name: Get all Sites Dhcpsettings
  cisco.catalystcenter.sites_dhcpSettings_info:
