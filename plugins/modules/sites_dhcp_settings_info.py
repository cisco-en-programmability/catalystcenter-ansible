...
short_description: Information module for Sites Dhcp Settings Info
description:
- This module represents an alias of the module sites_dhcp_settings_v1_info
...
notes:
  ...
  - It should be noted that this module is an alias of sites_dhcp_settings_v1_info

"""

EXAMPLES = r"""
- name: Get all Sites Dhcp Settings Info
  cisco.catalystcenter.sites_dhcp_settings_info:
