...
DOCUMENTATION = r"""
---
module: network_device_lexicographically_sorted_v1_info
short_description: Information module for Network Device Lexicographically Sorted V1
description:
- Get all Network Device Lexicographically Sorted V1.
...
EXAMPLES = r"""
- name: Get all Network Device Lexicographically Sorted V1
  cisco.catalystcenter.network_device_lexicographically_sorted_v1_info:
