...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Discovery CreateHTTPReadCredentialsV1
...
- name: Cisco CATALYST Center documentation for Discovery UpdateHTTPReadCredentialV1
