...
DOCUMENTATION = r"""
---
module: security_advisories_results_trend_v1_info
short_description: Information module for Security Advisories Results Trend V1
description:
- Get all Security Advisories Results Trend V1.
...
- name: Cisco DNA Center documentation for Compliance GetSecurityAdvisoriesResultsTrendOverTimeV1
  description: Complete reference of the GetSecurityAdvisoriesResultsTrendOverTimeV1 API.
  link: https://developer.cisco.com/docs/dna-center/#!get-security-advisories-results-trend-over-time
notes:
  - SDK Method used are
    compliance.Compliance.get_security_advisories_results_trend_over_time_v1,
...
EXAMPLES = r"""
- name: Get all Security Advisories Results Trend V1
  cisco.catalystcenter.security_advisories_results_trend_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
