...
DOCUMENTATION = r"""
---
module: wireless_enterprise_ssid_v1_info
short_description: Information module for Wireless Enterprise Ssid V1
description:
- Get all Wireless Enterprise Ssid V1.
- Get Enterprise SSID.
version_added: '3.1.0'
...
EXAMPLES = r"""
- name: Get all Wireless Enterprise Ssid V1
  cisco.catalystcenter.wireless_enterprise_ssid_v1_info:
