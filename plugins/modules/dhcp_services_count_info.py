...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Devices RetrievesTheTotalNumberOfDHCPServicesForGivenParameters
    description: Complete reference of the RetrievesTheTotalNumberOfDHCPServicesForGivenParameters API.
...
- name: Get all Dhcp Services Count
  cisco.catalystcenter.dhcp_services_count_info:
