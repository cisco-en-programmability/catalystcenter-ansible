...
DOCUMENTATION = r"""
---
module: network_device_interface_poe_v1_info
short_description: Information module for Network Device Interface Poe V1
description:
  - Get all Network Device Interface Poe V1.
  - >
    Returns POE interface details for the device, where deviceuuid is mandatory &
    accepts comma seperated interface
    names which is optional and returns information for that particular interfaces
    where operStatus =
    operationalStatus .
version_added: '3.1.0'
...
"""
EXAMPLES = r"""
- name: Get all Network Device Interface Poe V1
  cisco.catalystcenter.network_device_interface_poe_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
