...
DOCUMENTATION = r"""
---
module: sites_telemetrySettings_info
short_description: Information module for Sites Telemetrysettings
description:
- Get all Sites Telemetrysettings.
- >
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Network Settings RetrieveTelemetrySettingsForASiteV1
...
EXAMPLES = r"""
- name: Get all Sites Telemetrysettings
  cisco.catalystcenter.sites_telemetrySettings_info:
