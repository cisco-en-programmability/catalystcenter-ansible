...
DOCUMENTATION = r"""
---
module: transit_network_health_summaries_id_trend_analytics_v1_info
short_description: Information module for Transit Network Health Summaries Id Trend Analytics V1
description:
- Get all Transit Network Health Summaries Id Trend Analytics V1.
- >
   Get health time series for a specific Transit Network by providing the unique Transit Network id in the url path.
   The data will be grouped based on the specified trend time interval. If startTime and endTime are not provided,
...
- name: Cisco DNA Center documentation for SDA TheTrendAnalyticsDataForATransitNetworkInTheSpecifiedTimeRangeV1
  description: Complete reference of the TheTrendAnalyticsDataForATransitNetworkInTheSpecifiedTimeRangeV1 API.
...
EXAMPLES = r"""
- name: Get all Transit Network Health Summaries Id Trend Analytics V1
  cisco.catalystcenter.transit_network_health_summaries_id_trend_analytics_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
