...
DOCUMENTATION = r"""
---
module: images_count_v1_info
short_description: Information module for Images Count V1
description:
- Get all Images Count V1.
...
EXAMPLES = r"""
- name: Get all Images Count V1
  cisco.catalystcenter.images_count_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
