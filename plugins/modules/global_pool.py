...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Network Settings CreateGlobalPoolV1
...
- name: Cisco CATALYST Center documentation for Network Settings DeleteGlobalIPPoolV1
...
- name: Cisco CATALYST Center documentation for Network Settings UpdateGlobalPoolV1
