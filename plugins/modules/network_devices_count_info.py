...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Devices GetsTheTotalNetworkDeviceCountsBasedOnTheProvidedQueryParameters
    description: Complete reference of the GetsTheTotalNetworkDeviceCountsBasedOnTheProvidedQueryParameters API.
