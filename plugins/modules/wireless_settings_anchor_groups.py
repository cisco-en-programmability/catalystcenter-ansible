...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Wireless CreateAnchorGroup
  ...
  - name: Cisco DNA Center documentation for Wireless DeleteAnchorGroupByID
  ...
  - name: Cisco DNA Center documentation for Wireless UpdateAnchorGroup
