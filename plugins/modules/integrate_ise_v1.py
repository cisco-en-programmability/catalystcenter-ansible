...
DOCUMENTATION = r"""
---
module: integrate_ise_v1
short_description: Resource module for Integrate Ise V1
description:
  - Manage operation update of the resource Integrate Ise V1.
  - >
    API to accept Cisco ISE server certificate for Cisco ISE server integration. Use
    'Cisco ISE Server Integration
    Status' Intent API to check the integration status. This API can be used to retry
...
EXAMPLES = r"""
- name: Update by id
  cisco.catalystcenter.integrate_ise_v1:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
