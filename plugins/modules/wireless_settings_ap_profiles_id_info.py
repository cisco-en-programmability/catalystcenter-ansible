...
short_description: Information module for Wireless Settings
  Ap Profiles Id
description:
  - Get Wireless Settings Ap Profiles Id by id.
  - This API allows the user to get a AP Profile by
    AP Profile ID that captured in wireless settings
    design.
...
seealso:
  - name: Cisco DNA Center documentation for Wireless
      GetAPProfileByID
    description: Complete reference of the GetAPProfileByID
      API.
...
EXAMPLES = r"""
---
- name: Get Wireless Settings Ap Profiles Id by id
