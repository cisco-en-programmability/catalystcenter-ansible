...
DOCUMENTATION = r"""
---
module: dhcp_services_v1_info
short_description: Information module for Dhcp Services V1
description:
  - Get all Dhcp Services V1.
  - >
...
"""
EXAMPLES = r"""
- name: Get all Dhcp Services V1
  cisco.catalystcenter.dhcp_services_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
