...
notes:
  - SDK Method used are wireless.Wireless.get_count_of_anchor_groups_v1,
  - Paths used are get /dna/intent/api/v1/wirelessSettings/anchorGroups/count,
"""
EXAMPLES = r"""
- name: Get all Wireless Settings Anchor Groups Count V1
  cisco.catalystcenter.wireless_settings_anchor_groups_count_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
