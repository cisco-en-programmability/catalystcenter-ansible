...
seealso:
  - name: Cisco DNA Center documentation for Event Management
      GetAuditLogRecords
    description: Complete reference of the GetAuditLogRecords
      API.
    link: https://developer.cisco.com/docs/dna-center/#!get-audit-log-records
notes:
  - SDK Method used are
    event_management.EventManagement.get_audit_log_records,
  - Paths used are
...
- name: Get all Event Series Audit Logs
  cisco.catalystcenter.event_series_audit_logs_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
