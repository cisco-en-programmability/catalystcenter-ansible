...
DOCUMENTATION = r"""
---
module: wireless_controllers_primary_managed_ap_locations_v1_info
short_description: Information module for Wireless Controllers Primary Managed Ap Locations V1
description:
- Get all Wireless Controllers Primary Managed Ap Locations V1.
...
EXAMPLES = r"""
- name: Get all Wireless Controllers Primary Managed Ap Locations V1
  cisco.catalystcenter.wireless_controllers_primary_managed_ap_locations_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
