...
description:
  - Manage operation update of the resource Network Devices Update. - > Updates the network device with the given identifier.
    ...
    Access points associated with added WLC will be automatically added to inventory. For Meraki Dashboard, use the dashboard
...
options:
  category:
    ...
    type: str
  credentials:
    description: Network Devices Update's credentials.
    suboptions:
      cli:
        description: Network Devices Update's cli.
        suboptions:
          enablePassword:
        ...
        type: dict
      http:
        description: Network Devices Update's http.
        suboptions:
          password:
        ...
        type: dict
      meraki:
        description: Network Devices Update's meraki.
        suboptions:
          apiKey:
        ...
        type: dict
      netconf:
        description: Network Devices Update's netconf.
        suboptions:
          port:
        ...
        type: dict
      snmp:
        description: Network Devices Update's snmp.
        suboptions:
          authPassword:
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Devices UpdatesTheNetworkDevice
