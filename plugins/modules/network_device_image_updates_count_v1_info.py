...
DOCUMENTATION = r"""
---
module: network_device_image_updates_count_v1_info
short_description: Information module for Network Device Image Updates Count V1
description:
- Get all Network Device Image Updates Count V1.
...
EXAMPLES = r"""
- name: Get all Network Device Image Updates Count V1
  cisco.catalystcenter.network_device_image_updates_count_v1_info:
