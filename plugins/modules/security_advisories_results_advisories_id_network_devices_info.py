...
short_description: Information module for Security Advisories Results Advisories Id Network Devices
description:
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Compliance GetSecurityAdvisoryNetworkDeviceForTheSecurityAdvisoryByNetworkDeviceId
    description: Complete reference of the GetSecurityAdvisoryNetworkDeviceForTheSecurityAdvisoryByNetworkDeviceId API.
  ...
  - name: Cisco DNA Center documentation for Compliance GetSecurityAdvisoryNetworkDevicesForTheSecurityAdvisory
    description: Complete reference of the GetSecurityAdvisoryNetworkDevicesForTheSecurityAdvisory API.
