...
- >
   ...
   trend time Interval. The required property for this API is `trendInterval`. For detailed information about the
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.network_devices_trend_analytics_v1:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
