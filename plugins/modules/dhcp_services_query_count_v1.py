...
DOCUMENTATION = r"""
---
module: dhcp_services_query_count_v1
short_description: Resource module for Dhcp Services Query Count V1
description:
  - Manage operation create of the resource Dhcp Services Query Count V1.
  - >
    Retrieves the total number of DHCP Services and offers complex filtering and sorting
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.dhcp_services_query_count_v1:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
