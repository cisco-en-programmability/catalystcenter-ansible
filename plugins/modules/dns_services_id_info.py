...
short_description: Information module for Dns Services Id Info
description:
- This module represents an alias of the module dns_services_id_v1_info
...
notes:
  ...
  - It should be noted that this module is an alias of dns_services_id_v1_info

"""

EXAMPLES = r"""
- name: Get Dns Services Id Info by id
  cisco.catalystcenter.dns_services_id_info:
