...
short_description: Information module for Custom Issue Definitions
description:
...
options:
  ...
  id:
    description:
      - >
        Id query parameter. The custom issue definition identifier and unique identifier across the
