...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Reports GetAllViewGroupsV1
...
- name: Cisco CATALYST Center documentation for Reports GetViewsForAGivenViewGroupV1
