...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Network Settings RetrieveBannerSettingsForASiteV1
  description: Complete reference of the RetrieveBannerSettingsForASiteV1 API.
  link: https://developer.cisco.com/docs/dna-center/#!retrieve-banner-settings-for-a-site-v-1
notes:
  - SDK Method used are
...
- name: Get all Sites Bannersettings
  cisco.catalystcenter.sites_bannerSettings_info:
