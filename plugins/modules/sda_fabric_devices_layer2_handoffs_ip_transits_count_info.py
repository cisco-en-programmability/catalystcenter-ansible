...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for SDA GetFabricDevicesLayer3HandoffsWithIpTransitCountV1
...
- name: Get all Sda Fabricdevices Layer2handoffs Iptransits Count
  cisco.catalystcenter.sda_fabricDevices_layer2Handoffs_ipTransits_count_info:
