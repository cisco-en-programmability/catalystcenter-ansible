...
DOCUMENTATION = r"""
---
module: icap_capture_files_id_v1_info
short_description: Information module for Icap Capture Files Id V1
description:
  - Get Icap Capture Files Id V1 by id.
  - >
    Retrieves details of a specific ICAP packet capture file. For detailed information
...
"""
EXAMPLES = r"""
- name: Get Icap Capture Files Id V1 by id
  cisco.catalystcenter.icap_capture_files_id_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
