...
DOCUMENTATION = r"""
---
module: endpoint_analytics_profiling_rules_v1
short_description: Resource module for Endpoint Analytics Profiling Rules V1
description:
- Manage operations create, update and delete of the resource Endpoint Analytics Profiling Rules V1.
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.endpoint_analytics_profiling_rules_v1:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
