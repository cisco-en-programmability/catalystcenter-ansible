...
short_description: Information module for Field Notices Results Network Devices Info
description:
- This module represents an alias of the module field_notices_results_network_devices_v1_info
...
notes:
  - SDK Method used are
    compliance.Compliance.get_field_notice_network_devices_v1,

  - Paths used are
    get /dna/intent/api/v1/fieldNotices/results/networkDevices,
  - It should be noted that this module is an alias of field_notices_results_network_devices_v1_info

"""

EXAMPLES = r"""
- name: Get all Field Notices Results Network Devices Info
