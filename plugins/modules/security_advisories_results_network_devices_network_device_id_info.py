...
short_description: Information module for Security Advisories Results Network Devices Network Device Id Info
description:
...
EXAMPLES = r"""
- name: Get Security Advisories Results Network Devices Network Device Id Info by id
