...
short_description: Information module for Site Health Summaries Id Trend Analytics Info
description:
...
- name: Get all Site Health Summaries Id Trend Analytics Info
  cisco.catalystcenter.site_health_summaries_id_trend_analytics_info:
