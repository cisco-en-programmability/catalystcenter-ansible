...
description:
  - Manage operation create of the resource Dhcp Services Summary Analytics. - > Gets the summary analytics data related to
    DHCP Services based on given filters and group by field. For detailed information about the usage of the API, please refer
      ...
      filters:
        ...
        suboptions:
          ...
          operator:
            ...
            type: str
          value:
            description: Dhcp Services Summary Analytics's value.
            type: dict
        type: list
      key:
        description: Key.
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Devices GetSummaryAnalyticsDataOfDHCPServicesForGivenSetOfComplexFilters
    description: Complete reference of the GetSummaryAnalyticsDataOfDHCPServicesForGivenSetOfComplexFilters API.
