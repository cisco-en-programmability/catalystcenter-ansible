...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Discovery CreateNetconfCredentialsV1
...
- name: Cisco CATALYST Center documentation for Discovery UpdateNetconfCredentialsV1
