...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Devices GetDeviceCountKnowYourNetworkV1
...
- name: Cisco CATALYST Center documentation for Devices GetDeviceInterfaceCountV1
