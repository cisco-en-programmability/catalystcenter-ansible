...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Configuration Templates GetTemplateProject
  ...
  - name: Cisco DNA Center documentation for Configuration Templates GetTemplateProjects
