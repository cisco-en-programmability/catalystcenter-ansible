...
DOCUMENTATION = r"""
---
module: ipam_site_ip_address_pools_id_v1
short_description: Resource module for Ipam Site Ip Address Pools Id V1
description:
  - Manage operations update and delete of the resource Ipam Site Ip Address Pools
    Id V1.
  - Releases an IP address subpool.
  - Updates an IP address subpool, which reserves address space from a global pool
    or global pools for a particular site.
...
EXAMPLES = r"""
- name: Delete by id
  cisco.catalystcenter.ipam_site_ip_address_pools_id_v1:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
