...
DOCUMENTATION = r"""
---
module: sda_fabric_devices_layer2_handoffs_count_v1_info
short_description: Information module for Sda Fabric Devices Layer2 Handoffs Count V1
description:
- Get all Sda Fabric Devices Layer2 Handoffs Count V1.
...
EXAMPLES = r"""
- name: Get all Sda Fabric Devices Layer2 Handoffs Count V1
  cisco.catalystcenter.sda_fabric_devices_layer2_handoffs_count_v1_info:
    dnac_host: "{{dnac_host}}"
