...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Configuration Templates ImportsTheTemplatesProvidedV1
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.configuration_template_import_template:
