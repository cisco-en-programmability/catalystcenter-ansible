...
description:
- This module represents an alias of the module network_device_management_address_update_v1
...
notes:
  ...
  - It should be noted that this module is an alias of network_device_management_address_update_v1

"""

EXAMPLES = r"""
- name: Update all
  cisco.catalystcenter.network_device_management_address_update:
