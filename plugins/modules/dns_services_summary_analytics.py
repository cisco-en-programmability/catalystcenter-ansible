...
description:
  - Manage operation create of the resource Dns Services Summary Analytics. - > Gets the summary analytics data related to
    DNS Services based on given filters and group by field. For detailed information about the usage of the API, please refer
      ...
      filters:
        ...
        suboptions:
          ...
          operator:
            ...
            type: str
          value:
            description: Dns Services Summary Analytics's value.
            type: dict
        type: list
      key:
        description: Key.
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Devices GetSummaryAnalyticsDataOfDNSServicesForGivenSetOfComplexFilters
    description: Complete reference of the GetSummaryAnalyticsDataOfDNSServicesForGivenSetOfComplexFilters API.
...
---
- name: Create
  cisco.catalystcenter.dns_services_summary_analytics:
