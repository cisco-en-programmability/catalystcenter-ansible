...
DOCUMENTATION = r"""
---
module: sda_fabric_devices_layer2handoffs
short_description: Resource module for Sda Fabric Devices
  Layer2handoffs
description:
  - Manage operations create, update and delete of the
    resource Sda Fabric Devices Layer2handoffs.
...
options:
  ...
  networkDeviceId:
    ...
    type: str
  payload:
    description: Sda Fabric Devices Layer2handoffs's
      payload.
    elements: dict
    suboptions:
      externalVlanId:
...
---
- name: Delete all
  cisco.catalystcenter.sda_fabric_devices_layer2handoffs:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
