...
DOCUMENTATION = r"""
---
module: dns_services_query_count_v1
short_description: Resource module for Dns Services Query Count V1
description:
- Manage operation create of the resource Dns Services Query Count V1.
- >
...
- name: Cisco DNA Center documentation for Devices RetrievesTheTotalNumberOfDNSServicesForGivenSetOfComplexFiltersV1
  description: Complete reference of the RetrievesTheTotalNumberOfDNSServicesForGivenSetOfComplexFiltersV1 API.
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.dns_services_query_count_v1:
