...
DOCUMENTATION = r"""
---
module: snmp_properties_v1
short_description: Resource module for Snmp Properties V1
description:
- Manage operation create of the resource Snmp Properties V1.
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.snmp_properties_v1:
