...
DOCUMENTATION = r"""
---
module: network_device_meraki_organization_v1_info
short_description: Information module for Network Device Meraki Organization V1
description:
- Get all Network Device Meraki Organization V1.
...
EXAMPLES = r"""
- name: Get all Network Device Meraki Organization V1
  cisco.catalystcenter.network_device_meraki_organization_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
