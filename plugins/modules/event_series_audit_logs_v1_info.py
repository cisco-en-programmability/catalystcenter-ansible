...
DOCUMENTATION = r"""
---
module: event_series_audit_logs_v1_info
short_description: Information module for Event Series Audit Logs V1
description:
  - Get all Event Series Audit Logs V1.
...
notes:
  - SDK Method used are event_management.EventManagement.get_auditlog_records,
  - Paths used are get /dna/data/api/v1/event/event-series/audit-logs,
"""
EXAMPLES = r"""
- name: Get all Event Series Audit Logs V1
  cisco.catalystcenter.event_series_audit_logs_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
