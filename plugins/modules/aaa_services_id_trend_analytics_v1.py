...
DOCUMENTATION = r"""
---
module: aaa_services_id_trend_analytics_v1
short_description: Resource module for Aaa Services Id Trend Analytics V1
description:
- Manage operation create of the resource Aaa Services Id Trend Analytics V1.
- >
   Gets the trend analytics data related to a particular AAA Service matching the id. For detailed information about
...
EXAMPLES = r"""
- name: Create
  cisco.catalystcenter.aaa_services_id_trend_analytics_v1:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
