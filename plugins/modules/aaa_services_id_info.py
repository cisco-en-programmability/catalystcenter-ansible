...
short_description: Information module for Aaa Services
  Id
description:
  - Get Aaa Services Id by id. - > Retrieves the details
    of the AAA Service matching the given id. For detailed
...
options:
  ...
  id:
    description:
      - >
        Id path parameter. Unique id of the AAA Service.
        It is the combination of AAA Server IP (`serverIp`)
...
seealso:
  - name: Cisco DNA Center documentation for Devices
      RetrievesTheDetailsOfASpecificAAAServiceMatchingTheIdOfTheService
    description: Complete reference of the RetrievesTheDetailsOfASpecificAAAServiceMatchingTheIdOfTheService
      API.
...
EXAMPLES = r"""
---
- name: Get Aaa Services Id by id
  cisco.catalystcenter.aaa_services_id_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
