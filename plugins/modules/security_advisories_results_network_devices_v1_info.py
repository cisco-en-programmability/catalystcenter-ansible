...
short_description: Information module for Security Advisories Results Network Devices V1
description:
...
notes:
  - SDK Method used are
    compliance.Compliance.get_security_advisory_network_devices_v1,
...
- name: Get all Security Advisories Results Network Devices V1
  cisco.catalystcenter.security_advisories_results_network_devices_v1_info:
