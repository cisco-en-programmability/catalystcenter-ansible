...
DOCUMENTATION = r"""
---
module: site_health_summaries_id_trend_analytics_v1_info
short_description: Information module for Site Health Summaries Id Trend Analytics V1
description:
- Get all Site Health Summaries Id Trend Analytics V1.
- >
   Retrieves the time series information of health and issue data for a site specified by the path parameter. The
   data will be grouped based on the specified trend time interval. For detailed information about the usage of the
   API, please refer to the Open API specification document - https //github.com/cisco-en-programmability/catalyst-
   center-api-specs/blob/main/Assurance/CE_Cat_Center_Org-siteHealthSummaries-2.0.0-resolved.yaml.
...
options:
  ...
  attribute:
    ...
    - >
      ...
      wirelessClientCount, wiredClientGoodHealthCount, wirelessClientGoodHealthCount, clientGoodHealthPercentage,
      wiredClientGoodHealthPercentage, wirelessClientGoodHealthPercentage, clientDataUsage, p1IssueCount,
      p2IssueCount, p3IssueCount, p4IssueCount, issueCount attribute=networkDeviceCount (single attribute
      requested) attribute=networkDeviceCount&attribute=clientCount (multiple attributes requested).
    type: str
  taskId:
    description:
    - >
...
- name: Cisco DNA Center documentation for Sites ReadTrendAnalyticsDataForASpecificSiteInYourNetworkV1
  description: Complete reference of the ReadTrendAnalyticsDataForASpecificSiteInYourNetworkV1 API.
  link: https://developer.cisco.com/docs/dna-center/#!read-trend-analytics-data-for-a-specific-site-in-your-network
notes:
  - SDK Method used are
    sites.Sites.read_trend_analytics_data_for_a_specific_site_in_your_network_v1,
...
EXAMPLES = r"""
- name: Get all Site Health Summaries Id Trend Analytics V1
  cisco.catalystcenter.site_health_summaries_id_trend_analytics_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
