...
short_description: Information module for Network Bugs Results Network Devices Network Device Id Bugs Count Info
description:
...
EXAMPLES = r"""
- name: Get all Network Bugs Results Network Devices Network Device Id Bugs Count Info
