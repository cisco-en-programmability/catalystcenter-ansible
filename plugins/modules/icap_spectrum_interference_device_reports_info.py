...
description:
  - Get all Icap Spectrum Interference Device Reports. - > Retrieves the spectrum interference devices reports sent by WLC
    for provided AP Mac. For detailed information about the usage of the API, please refer to the Open API specification document
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco DNA Center documentation for Sensors RetrievesTheSpectrumInterferenceDevicesReportsSentByWLCForProvidedAPMac
    description: Complete reference of the RetrievesTheSpectrumInterferenceDevicesReportsSentByWLCForProvidedAPMac API.
