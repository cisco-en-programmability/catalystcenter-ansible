...
short_description: Information module for Network Bugs Results Bugs Id Network Devices Count Info
description:
...
- name: Cisco DNA Center documentation for Compliance GetCountOfNetworkBugDevicesForTheBugV1
  description: Complete reference of the GetCountOfNetworkBugDevicesForTheBugV1 API.
  link: https://developer.cisco.com/docs/dna-center/#!get-count-of-network-bug-devices-for-the-bug
notes:
  - SDK Method used are
    compliance.Compliance.get_count_of_network_bug_devices_for_the_bug_v1,
