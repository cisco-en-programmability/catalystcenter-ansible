...
description:
  - This module represents an alias of the module service_provider_update_v1
version_added: '3.1.0'
...
notes:
  ...
  - It should be noted that this module is an alias of service_provider_update_v1
"""
EXAMPLES = r"""
- name: Update all
  cisco.catalystcenter.service_provider_update:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
