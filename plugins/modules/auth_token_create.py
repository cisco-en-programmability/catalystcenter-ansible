...
- >
   ...
   set as value to the X-Auth-Token HTTP Header for all API calls to Cisco CATALYST Center.
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Authentication AuthenticationAPIV1
