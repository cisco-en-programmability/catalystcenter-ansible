...
short_description: Information module for Energy Sites Count
description:
...
seealso:
  - name: Cisco DNA Center documentation for Sites CountSitesEnergy
    description: Complete reference of the CountSitesEnergy API.
...
- name: Get all Energy Sites Count
  cisco.catalystcenter.energy_sites_count_info:
