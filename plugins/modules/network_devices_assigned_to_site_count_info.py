...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Site Design GetSiteAssignedNetworkDevicesCountV1
...
- name: Get all Networkdevices Assignedtosite Count
  cisco.catalystcenter.networkDevices_assignedToSite_count_info:
