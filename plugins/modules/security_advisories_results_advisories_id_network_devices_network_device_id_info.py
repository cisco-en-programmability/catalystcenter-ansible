...
short_description: Information module for Security Advisories Results Advisories Id Network Devices Network Device Id Info
description:
- This module represents an alias of the module security_advisories_results_advisories_id_network_devices_network_device_id_v1_info
...
notes:
  ...
  - It should be noted that this module is an alias of security_advisories_results_advisories_id_network_devices_network_device_id_v1_info

"""

EXAMPLES = r"""
- name: Get Security Advisories Results Advisories Id Network Devices Network Device Id Info by id
