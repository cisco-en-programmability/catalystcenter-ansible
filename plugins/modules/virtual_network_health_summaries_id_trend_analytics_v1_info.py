...
short_description: Information module for Virtual Network Health Summaries Id Trend Analytics V1
description:
...
- name: Get all Virtual Network Health Summaries Id Trend Analytics V1
  cisco.catalystcenter.virtual_network_health_summaries_id_trend_analytics_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
