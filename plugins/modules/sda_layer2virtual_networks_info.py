...
DOCUMENTATION = r"""
---
module: sda_layer2virtual_networks_info
short_description: Information module for Sda Layer2virtual
  Networks
description:
  - Get all Sda Layer2virtual Networks.
...
EXAMPLES = r"""
---
- name: Get all Sda Layer2virtual Networks
  cisco.catalystcenter.sda_layer2virtual_networks_info:
    dnac_host: "{{dnac_host}}"
