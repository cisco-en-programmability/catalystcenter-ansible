...
DOCUMENTATION = r"""
---
module: wirelessControllers_managedApLocations_count_info
short_description: Information module for Wirelesscontrollers Managedaplocations Count
description:
- Get all Wirelesscontrollers Managedaplocations Count.
- >
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Wireless GetManagedAPLocationsCountForSpecificWirelessControllerV1
...
EXAMPLES = r"""
- name: Get all Wirelesscontrollers Managedaplocations Count
  cisco.catalystcenter.wirelessControllers_managedApLocations_count_info:
