...
DOCUMENTATION = r"""
---
module: license_usage_details_v1_info
short_description: Information module for License Usage Details V1
description:
  - Get License Usage Details V1 by name.
...
- name: Get License Usage Details V1 by name
  cisco.catalystcenter.license_usage_details_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
