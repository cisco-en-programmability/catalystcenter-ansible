...
short_description: Information module for Wireless Settings Rf Profiles Count Info
description:
- This module represents an alias of the module wireless_settings_rf_profiles_count_v1_info
...
notes:
  ...
  - It should be noted that this module is an alias of wireless_settings_rf_profiles_count_v1_info

"""

EXAMPLES = r"""
- name: Get all Wireless Settings Rf Profiles Count Info
