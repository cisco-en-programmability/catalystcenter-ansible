...
DOCUMENTATION = r"""
---
module: maps_import_status_v1_info
short_description: Information module for Maps Import Status V1
description:
  - Get all Maps Import Status V1.
  - >
    Gets the status of a map archive import operation. For a map archive import that
    has just been initiated, will
    provide the result of validation of the archive and a pre-import preview of what
    will be performed if the import
    is performed. Once an import is requested to be performed, this API will give
    the status of the import and upon
...
"""
EXAMPLES = r"""
- name: Get all Maps Import Status V1
  cisco.catalystcenter.maps_import_status_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
