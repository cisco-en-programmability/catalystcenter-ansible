...
DOCUMENTATION = r"""
---
module: virtual_network_health_summaries_v1_info
short_description: Information module for Virtual Network Health Summaries V1
description:
  - Get all Virtual Network Health Summaries V1.
  - >
    Get a paginated list of Virtual Networks with health summary. Layer 2 Virtual
    Networks are only included in health
    reporting for EVPN protocol deployments. The special Layer 3 VN called 'INFRA_VN'
    is also not included for user
    access through Assurance virtualNetworkHealthSummaries APIS. Please find INFRA_VN
    related health metrics under
    /data/api/v1/fabricSiteHealthSummaries Ex attributes 'pubsubInfraVnGoodHealthPercentage'
    and
...
"""
EXAMPLES = r"""
- name: Get all Virtual Network Health Summaries V1
  cisco.catalystcenter.virtual_network_health_summaries_v1_info:
    _host: "{{ _host }}"
    _username: "{{ _username }}"
    _password: "{{ _password }}"
    _verify: "{{ _verify }}"
