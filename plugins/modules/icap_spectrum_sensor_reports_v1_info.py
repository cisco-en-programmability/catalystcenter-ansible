...
DOCUMENTATION = r"""
---
module: icap_spectrum_sensor_reports_v1_info
short_description: Information module for Icap Spectrum Sensor Reports V1
description:
- Get all Icap Spectrum Sensor Reports V1.
- >
   Retrieves the spectrum sensor reports sent by WLC for provided AP Mac. For detailed information about the usage of
...
EXAMPLES = r"""
- name: Get all Icap Spectrum Sensor Reports V1
  cisco.catalystcenter.icap_spectrum_sensor_reports_v1_info:
