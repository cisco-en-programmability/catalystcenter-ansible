...
short_description: Information module for Wireless Controllers Wireless Mobility Groups Count V1
description:
...
- name: Get all Wireless Controllers Wireless Mobility Groups Count V1
  cisco.catalystcenter.wireless_controllers_wireless_mobility_groups_count_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
