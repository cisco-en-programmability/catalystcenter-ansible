...
DOCUMENTATION = r"""
---
module: sites_dnsSettings
short_description: Resource module for Sites Dnssettings
description:
- Manage operation update of the resource Sites Dnssettings.
- >
...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Network Settings SetDNSSettingsForASiteV1
...
EXAMPLES = r"""
- name: Update all
  cisco.catalystcenter.sites_dnsSettings:
