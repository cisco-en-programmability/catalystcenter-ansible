...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for Software Image Management (SWIM) ReturnsTheCountOfNetworkDeviceProductNamesForASiteV1
...
- name: Get all Sitewiseproductnames Count
  cisco.catalystcenter.siteWiseProductNames_count_info:
