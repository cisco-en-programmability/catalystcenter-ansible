...
short_description: Information module for Wireless Controllers Mesh Ap Neighbours V1
description:
...
- name: Get all Wireless Controllers Mesh Ap Neighbours V1
  cisco.catalystcenter.wireless_controllers_mesh_ap_neighbours_v1_info:
    host: "{{host}}"
    username: "{{username}}"
    password: "{{password}}"
    verify: "{{verify}}"
