...
- python >= 3.5
seealso:
- name: Cisco CATALYST Center documentation for SDA AddEdgeDeviceInSDAFabricV1
...
- name: Cisco CATALYST Center documentation for SDA DeleteEdgeDeviceFromSDAFabricV1
