...
class TestDnacNetworkDevicesInfoWorkflowManager(TestCatalystModule):
    ...
    playbook_device_interfaces_by_range_info = test_data.get(
        "playbook_device_interfaces_by_range_info"
    )
        ...
        self.assertEqual(
            ...
            [
                ...
                [
                    {
                        "line_card_info": [
                            {"device_ip": "204.1.2.1", "linecard_details": []}
                        ]
                    }
                ],
            ],
                ...
                [
                    {
                        "supervisor_card_info": [
                            {"device_ip": "204.1.2.1", "supervisor_card_details": []}
                        ]
                    }
                ],
            ],
        ...
        self.assertEqual(
            ...
            [
                ...
                [
                    {
                        "module_count_info": [
                            {"device_ip": "204.1.2.1", "module_count_details": 2}
                        ]
                    }
                ],
            ],
    ...
    def test_network_devices_info_workflow_manager_playbook_device_interfaces_by_range_info(
        self,
    ):
        """
                        ...
                        "interface_vlan_info": [
                            {
                                ...
                                "interface_vlan_details": [
                                    {"interfaceName": "LISP0.4097", "vlanType": ""},
                                    {"interfaceName": "LISP0.4102", "vlanType": ""},
                                    {"interfaceName": "LISP0.4110", "vlanType": ""},
                                    {"interfaceName": "LISP0.4106", "vlanType": ""},
                                    {"interfaceName": "LISP0.4098", "vlanType": ""},
                                    {"interfaceName": "LISP0.4111", "vlanType": ""},
                                    {"interfaceName": "LISP0.4108", "vlanType": ""},
                                    {"interfaceName": "LISP0.4105", "vlanType": ""},
                                    {"interfaceName": "LISP0.4103", "vlanType": ""},
                                    {"interfaceName": "LISP0.4113", "vlanType": ""},
                                    {"interfaceName": "LISP0.4114", "vlanType": ""},
                                    {"interfaceName": "LISP0.4100", "vlanType": ""},
                                    {"interfaceName": "LISP0.4101", "vlanType": ""},
                                    {"interfaceName": "LISP0.4104", "vlanType": ""},
                                    {"interfaceName": "LISP0.4112", "vlanType": ""},
                                    {"interfaceName": "LISP0.4109", "vlanType": ""},
                                    {"interfaceName": "LISP0.4099", "vlanType": ""},
                                    {"interfaceName": "LISP0.4107", "vlanType": ""},
                                    {
    ...
    def test_network_devices_info_workflow_manager_playbook_negative_scenario4(self):
        ...
        print(result)
        self.assertEqual(
            result.get("response"), "'retries' must be a non-negative integer"
        )
    ...
    def test_network_devices_info_workflow_manager_playbook_negative_scenario7(self):
        ...
        print(result)
        self.assertEqual(
            result.get("response"), "'file_format' must be one of: json, yaml"
        )
    ...
    def test_network_devices_info_workflow_manager_playbook_negative_scenario8(self):
        ...
        result = self.execute_module(changed=False, failed=True)
        print(result)
        self.assertEqual(result.get("response"), "'file_mode' must be one of: a, w")
