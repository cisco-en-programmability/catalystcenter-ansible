...
from ansible_collections.cisco.catalystcenter.plugins.modules import network_devices_info_workflow_manager
from .catalystcenter_module import TestCatalystModule, set_module_args, loadPlaybookData


class TestCatalystCenterNetworkDevicesInfoWorkflowManager(TestCatalystModule):
    ...
    def setUp(self):
        super(TestCatalystCenterNetworkDevicesInfoWorkflowManager, self).setUp()
    ...
    def tearDown(self):
        super(TestCatalystCenterNetworkDevicesInfoWorkflowManager, self).tearDown()
                        ...
                        'device_config_info': [
                            {
                                ...
                                '\n !\n address-family ipv4\n exit-address-family\n !\n address-family ipv6\n exit-address-family\n!\n'
                                'no logging console\nno logging monitor\naaa new-model\n!\n!\naaa group server radius catalystcenter-client-ra'
                                'dius-group\n server name catalystcenter-radius_172.23.241.229\n ip radius source-interface Loopback0\n!\naaa g'
                                'roup server radius catalystcenter-network-radius-group\n server name catalystcenter-radius_172.23.241.229\n ip radius so'
                                'urce-interface Loopback0\n!\naaa authentication login default local\naaa authentication login catalystcenter-c'
                                'ts-list group catalystcenter-client-radius-group local\naaa authentication login VTY_authen group catalystcenter-network'
                                '-radius-group local\naaa authentication dot1x default group catalystcenter-client-radius-group\naaa authorizat'
                                'ion exec default local \naaa authorization exec VTY_author group catalystcenter-network-radius-group local if-'
                                'authenticated \naaa authorization network default group catalystcenter-client-radius-group \naaa authorization'
                                ' network catalystcenter-cts-list group catalystcenter-client-radius-group \naaa accounting update newinfo periodic 2880\n'
                                'aaa accounting identity default start-stop group catalystcenter-client-radius-group\naaa accounting exec defa'
                                'ult start-stop group catalystcenter-network-radius-group\n!\n!\naaa server radius dynamic-author\n client 172.'
                                ...
                                'n-success log\nipv6 nd raguard policy catalystcenter-sda-permit-nd-raguardv6\n device-role router\n!\nipv6 uni'
                                'cast-routing\nipv6 mld snooping\nipv6 dhcp guard policy catalystcenter-sda-permit-dhcpv6\n device-role server\n'
                                ...
                                'radius-server dead-criteria time 5 tries 3\nradius-server deadtime 3\n!\nradius server catalystcenter-radius_'
