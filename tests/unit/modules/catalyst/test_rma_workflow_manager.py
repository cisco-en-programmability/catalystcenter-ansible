...
from .catalystcenter_module import TestCatalystcenterModule, set_module_args, loadPlaybookData


class TestCatalystcenterRmaIntent(TestCatalystcenterModule):
    ...
    def setUp(self):
        super(TestCatalystcenterRmaIntent, self).setUp()
    ...
    def tearDown(self):
        super(TestCatalystcenterRmaIntent, self).tearDown()
