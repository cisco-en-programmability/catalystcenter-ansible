...
class TestCatalystcenterUserRoleWorkflowManager(TestCatalystcenterModule):
    ...
    def test_user_role_workflow_manager_user_update_not_needed(self):
        ...
        print(result)
        self.assertEqual(result.get("response"), "User does not need any update")
...
and hyphens and should not contain spaces or other special characters.",
    ...
    def test_user_role_workflow_manager_role_update_not_needed(self):
        ...
        result = self.execute_module(changed=False, failed=False)
        print(result)
        self.assertEqual(result.get("response"), "Role does not need any update")
    ...
    def test_user_role_workflow_manager_delete_non_existing_role(self):
        ...
        print(result)
        self.assertEqual(
            result.get("msg"), "Please provide a valid role_name for role deletion"
        )
    ...
    def test_user_role_workflow_manager_invalid_param_role_invalid_permission(self):
        ...
        print(result)
        self.assertEqual(
            result.get("msg"), "Invalid permission aaa for assurance resource overall"
        )
