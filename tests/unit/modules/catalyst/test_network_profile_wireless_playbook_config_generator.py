...
#   profile wireless configurations in Cisco Catalyst Center.
...
from ansible_collections.cisco.catalystcenter.plugins.modules import network_profile_wireless_playbook_config_generator
from .catalystcenter_module import TestCatalystModule, set_module_args, loadPlaybookData


class TestNetworkProfileWirelessPlaybookConfigGenerator(TestCatalystModule):
