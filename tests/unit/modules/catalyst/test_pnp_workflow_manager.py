...
class TestCatalystCenterPnpWorkflow(TestCatalystModule):
    """
    ...
    def tearDown(self):
        super(TestCatalystCenterPnpWorkflow, self).tearDown()
    ...
    def test_pnp_workflow_manager_version_3_1_0_features(self):
        ...
        set_module_args(
            dict(
                ...
                catalystcenter_username="dummy",
                catalystcenter_password="dummy",
                catalystcenter_version="3.1.0.0",
                catalystcenter_log=True,
                state="merged",
                config_verify=True,
    ...
    def test_pnp_workflow_manager_version_check(self):
        ...
        set_module_args(
            dict(
                ...
                catalystcenter_username="dummy",
                catalystcenter_password="dummy",
                catalystcenter_version="2.3.5.2",
                catalystcenter_log=True,
                config_verify=True,
                state="merged",
                config=self.playbook_config_pnp
