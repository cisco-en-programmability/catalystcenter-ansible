...
class TestCatalystcenterAccesspointWorkflow(TestCatalystcenterModule):
    ...
    playbook_config_missing_rf_profile = test_data.get(
        "playbook_config_missing_rf_profile"
    )
    ...
    playbook_invalid_config_provision = test_data.get(
        "playbook_invalid_config_provision"
    )
    ...
    def tearDown(self):
        super(TestCatalystcenterAccesspointWorkflow, self).tearDown()
    ...
    def test_accesspoint_workflow_manager_missing_rf_profile(self):
        ...
        self.assertEqual(result.get("msg"), "MAC Address is not Access point")
    ...
    def test_accesspoint_workflow_manager_already_provision_device(self):
        ...
        self.assertEqual(
            result.get("ap_update_msg"), "AP - NY-AP1-9130AXE does not need any update"
        )
    ...
    def test_invalid_wlc_device(self):
        ...
        result = self.execute_module(changed=False, failed=True)
        print(result)
        self.assertEqual(result.get("msg"), "Wireles controller is not provisioned:")
